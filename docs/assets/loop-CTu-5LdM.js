...
void main() {
	...
	`}var Vo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ll.BlurDirectionX=new K(1,0),Ll.BlurDirectionY=new K(0,1);var Rl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},zl=class extends Dl{constructor(){super(),this.isOutputPass=!0,this.uniforms=na.clone(Rl.uniforms),this.material=new oa({name:Rl.name,uniforms:this.uniforms,vertexShader:Rl.vertexShader,fragmentShader:Rl.fragmentShader}),this._fsQuad=new Al(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function Bl(e,t,n){return e&&e!==`disc`?t:`saucer-${n%4+1}`}var Vl=96,Hl={saucer:14,cow:5,pig:3.4,sheep:2.8,chicken:.9,farmer:2.4,civilian:2.2,tractor:9,pickup:7,sedan:5.5,jeep:8,tank:18,heli:6,plane:5,barn:0,farmhouse:0,townhouse:0,shop:0,silo:0,special:0,loot:.4,prop:0,rubble:2.2,laser:.2,bullet:.15};function Ul(e){if(e.invMass!=null)return e.invMass;let t=e.mass??Hl[e.kind]??2;return t>0?1/t:0}function Wl(e){return Ul(e)===0}function Gl(e,t){return e+512<<16|t+512&65535}function Kl(e,t){let n=Gl(Math.floor(t.x/Vl),Math.floor(t.y/Vl)),r=e.get(n);r||(r=[],e.set(n,r)),r.push(t)}function ql(e,t,n,r,i){i.length=0;let a=Math.floor((t+r)/Vl),o=Math.floor((t-r)/Vl),s=Math.floor((n+r)/Vl),c=Math.floor((n-r)/Vl);for(let t=c;t<=s;t++)for(let n=o;n<=a;n++){let r=e.get(Gl(n,t));if(r)for(let e of r)i.push(e)}return i}function Jl(e,t){let n=e.drag??(e.kind===`rubble`?2.4:1.6),r=Math.exp(-n*t);e.vx*=r,e.vy*=r,e.x+=e.vx*t,e.y+=e.vy*t,e.spin&&(e.facing+=e.spin*t),e.x<36?(e.x=36,e.vx=Math.abs(e.vx)*(e.restitution??.2)):e.x>4860&&(e.x=f-36,e.vx=-Math.abs(e.vx)*(e.restitution??.2)),e.y<36?(e.y=36,e.vy=Math.abs(e.vy)*(e.restitution??.2)):e.y>3564&&(e.y=h-36,e.vy=-Math.abs(e.vy)*(e.restitution??.2))}function Yl(e,t){let n=Ul(e),r=Ul(t);if(n===0&&r===0)return;let i=t.x-e.x,a=t.y-e.y,o=e.r+t.r,s=i*i+a*a;if(s>o*o||s<1e-8)return;let c=Math.sqrt(s),l=i/c,u=a/c,d=o-c,f=n+r;e.x-=l*d*(n/f),e.y-=u*d*(n/f),t.x+=l*d*(r/f),t.y+=u*d*(r/f);let p=t.vx-e.vx,m=t.vy-e.vy,h=p*l+m*u;if(h>0)return;let g=-(1+Math.min(e.restitution??.15,t.restitution??.15))*h/f;e.vx-=g*l*n,e.vy-=g*u*n,t.vx+=g*l*r,t.vy+=g*u*r}function Xl(e,t,n){let r=Ul(e);r!==0&&(e.vx+=t*r,e.vy+=n*r)}function Zl(e,t,n,r,i){let a=r*r;for(let o of e.actors){if(o.dead&&o.kind!==`rubble`)continue;let e=o.x-t,s=o.y-n,c=e*e+s*s;if(c>a||c<1)continue;let l=Math.sqrt(c),u=1-l/r;Xl(o,e/l*i*u,s/l*i*u),o.spin=(o.spin??0)+(Math.random()-.5)*8*u,o.flee=Math.max(o.flee,1.1)}let o=e.saucer,s=o.x-t,c=o.y-n,l=s*s+c*c;if(l<a&&l>1){let e=Math.sqrt(l),t=1-e/r;o.knockX=(o.knockX??0)+s/e*90*t,o.knockY=(o.knockY??0)+c/e*90*t}}function Ql(e,t,n,r,i=1){let a=(t-e.x)*22-e.vx*6,o=(n-16-e.y)*22-e.vy*6;Xl(e,a*r*18,o*r*18),e.lift+=r*i}function $l(e){let t=new Map;for(let n of e.actors)n.dead&&n.kind!==`rubble`||Kl(t,n);let n=[];for(let r of e.actors)if(!(r.dead&&r.kind!==`rubble`)&&!Wl(r)){ql(t,r.x,r.y,r.r+48,n);for(let e of n)e.id<=r.id||e.dead&&e.kind!==`rubble`||!r.solid&&!e.solid&&r.kind!==`rubble`&&e.kind!==`rubble`&&(!r.abductable||!e.abductable)||Yl(r,e)}}function eu(e,t,n,r,i,a,o){let s=n-e,c=r-t,l=e-i,u=t-a,d=s*s+c*c,f=2*(l*s+u*c),p=l*l+u*u-o*o;if(d<1e-8)return p<=0;let m=f*f-4*d*p;if(m<0)return!1;m=Math.sqrt(m);let h=(-f-m)/(2*d),g=(-f+m)/(2*d);return h>=0&&h<=1||g>=0&&g<=1||h<0&&g>1}function tu(e,t,n){return Math.max(t,Math.min(n,e))}function nu(e,t,n,r,i,a,o,s,c=0){let l=e.particles.find(e=>!e.alive);l&&(l.alive=!0,l.x=t,l.y=n,l.vx=r,l.vy=i,l.life=a,l.max=a,l.size=o,l.color=s,l.gravity=c)}function ru(e,t,n,r,i,a=180){for(let o=0;o<r;o++){let r=Math.random()*Math.PI*2,o=a*(.35+Math.random());nu(e,t,n,Math.cos(r)*o,Math.sin(r)*o,.35+Math.random()*.45,2+Math.random()*4,i,40)}}function iu(e,t,n,r){e.popups.push({x:t,y:n,text:r,life:.9,max:.9})}function au(e,t,n,r){let i=e.state;i.comboTimer>0?i.combo+=1:i.combo=1,i.comboTimer=2.3,i.stats.maxCombo=Math.max(i.stats.maxCombo,i.combo);let a=Math.min(6,1+Math.floor((i.combo-1)/2)),o=t*a;i.score+=o,iu(e,n,r-20,a>1?`+${o}  ×${a}`:`+${o}`)}function ou(e,t,n){if(!t.dead){if(t.dead=!0,n===`abduct`)su(e,t),r.abduct(),ru(e,t.x,t.y,14,`#7dffb2`,140),ru(e,t.x,t.y,8,`#e8ffe8`,80);else if(cu(e,t),r.explode(),e.explosions.push({x:t.x,y:t.y,t:0,scale:t.r>40?1.6:1}),ru(e,t.x,t.y,22,`#ffb060`,260),ru(e,t.x,t.y,10,`#3a2a22`,120),Zl(e,t.x,t.y,t.r>40?240:150,t.r>40?980:520),e.state.shake=Math.min(1,e.state.shake+(t.r>40?.55:.32)),e.state.hitstop=t.r>40?.05:.03,t.destructible&&t.kind!==`prop`&&t.kind!==`loot`){let n=t.r>40?5:3;for(let r=0;r<n;r++){let i=Math.PI*2*r/n+Math.random()*.4,a=80+Math.random()*160;e.actors.push({...t,id:t.id+9e4+r,kind:`rubble`,sprite:`rubble-${1+(t.id+r)%4}`,hp:1,dead:!1,destructible:!1,abductable:!1,solid:!1,w:t.w*(.28+Math.random()*.25),h:t.h*(.22+Math.random()*.2),r:t.r*.28,x:t.x+Math.cos(i)*10,y:t.y+Math.sin(i)*10,vx:Math.cos(i)*a,vy:Math.sin(i)*a,spin:(Math.random()-.5)*10,mass:1.6,invMass:1/1.6,restitution:.25,drag:2.2})}}e.state.heat=tu(e.state.heat+t.heat*(e.state.heatMult||1),0,100),e.state.alert=u(e.state.heat),n===`blast`&&t.kind===`special`&&du(e,t)}}function su(e,t){let n=e.state.stats;n.abducted+=1,(t.kind===`cow`||t.kind===`pig`||t.kind===`sheep`||t.kind===`chicken`)&&(n.cows+=1),(t.kind===`farmer`||t.kind===`civilian`)&&(n.people+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`||t.kind===`tank`||t.kind===`heli`||t.kind===`plane`)&&(n.vehicles+=1),au(e,t.score,t.x,t.y),t.boss&&_u(e,t)}function cu(e,t){let n=e.state.stats;n.destroyed+=1,(t.kind===`barn`||t.kind===`farmhouse`||t.kind===`townhouse`||t.kind===`shop`||t.kind===`silo`||t.kind===`special`)&&(n.buildings+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`||t.kind===`tank`||t.kind===`heli`||t.kind===`plane`)&&(n.vehicles+=1),au(e,Math.round(t.score*.85),t.x,t.y),t.boss&&_u(e,t)}function lu(e,t){let n=null,r=320;for(let i of e.actors){if(i.dead||!i.destructible&&!i.abductable||i.kind===`rubble`)continue;let e=Math.hypot(i.x-t.x,i.y-t.y);e<r&&(r=e,n=i)}return n}function uu(e,t,n){let i=Math.hypot(t,n)||1;t/=i,n/=i;let a=e.saucer,o=e.state.weaponTier??0,s=[[t,n]];if(o>=2&&(-n*14,t*14,s.length=0,s.push([t,n]),s.push([t,n])),o>=3){let e=Math.atan2(n,t);s.length=0;for(let t of[-.28,0,.28])s.push([Math.cos(e+t),Math.sin(e+t)])}else o>=2&&(s.length=0,s.push([t,n],[t,n]));let c=o===2;s.forEach((r,i)=>{let o=c?-n*(i===0?-12:12):0,s=c?t*(i===0?-12:12):0;e.lasers.push({id:8e4+e.lasers.length+i,kind:`laser`,x:a.x+r[0]*36+o,y:a.y+r[1]*36+s,vx:r[0]*680,vy:r[1]*680,r:8,w:22,h:10,hp:1,maxHp:1,facing:Math.atan2(r[1],r[0]),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`laser`,flash:0,dead:!1,flee:0,wanderT:.7,wanderA:0,fireCd:0,z:a.y})}),r.laser(),e.state.shake=Math.min(1,e.state.shake+.08)}function du(e,t){let n=t.loot??(Math.random()<.5?`weapon`:`cloak`);e.actors.push({id:5e4+Math.floor(Math.random()*9e3),kind:`loot`,x:t.x,y:t.y,vx:0,vy:0,r:18,w:36,h:36,hp:1,maxHp:1,facing:0,lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:n===`weapon`?`pickup-weapon`:`pickup-cloak`,flash:0,dead:!1,flee:0,wanderT:18,wanderA:0,fireCd:0,z:t.y,loot:n}),iu(e,t.x,t.y-24,n===`weapon`?`WEAPON CACHE`:`CLOAK`)}function fu(e,n){n.dead||(n.dead=!0,n.loot===`weapon`?(e.state.weaponTier=Math.min(3,(e.state.weaponTier??0)+1),iu(e,n.x,n.y-20,[`Laser`,`Laser+`,`Twin`,`Spread`][e.state.weaponTier]),r.upgrade()):(e.state.cloakT=Math.min(16,(e.state.cloakT??0)+10),iu(e,n.x,n.y-20,`CLOAK`),r.cloak()),ru(e,n.x,n.y,16,n.loot===`weapon`?`#ffb060`:`#c9a0ff`,160),t.tap())}function pu(e,t,n,r,i,a,o,s=2.1){let c=Math.hypot(r,i)||1;r/=c,i/=c,e.bullets.push({id:6e4+e.bullets.length+Math.floor(Math.random()*500),kind:`bullet`,x:t+r*28,y:n+i*28,vx:r*a,vy:i*a,r:6+o,w:10,h:10,hp:1,maxHp:1,facing:Math.atan2(i,r),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`bullet`,flash:0,dead:!1,flee:0,wanderT:s,wanderA:0,fireCd:0,z:n,dmg:o,mass:.15,invMass:1/.15})}function mu(){let e=Math.floor(Math.random()*4);return e===0?{x:Math.random()*f,y:60}:e===1?{x:f-60,y:Math.random()*h}:e===2?{x:Math.random()*f,y:h-60}:{x:60,y:Math.random()*h}}function hu(e,t){let n=mu(),r={jeep:{r:26,w:64,h:40,hp:70,score:480,heat:3,abduct:!0,t:1.2,sprite:`jeep`},tank:{r:34,w:86,h:48,hp:160,score:900,heat:4,abduct:!0,t:1.8,sprite:`tank`},heli:{r:30,w:72,h:64,hp:90,score:760,heat:3,abduct:!1,t:0,sprite:`heli`},plane:{r:28,w:88,h:56,hp:80,score:820,heat:3,abduct:!1,t:0,sprite:`plane`}}[t];e.actors.push({id:7e4+Math.floor(Math.random()*9999),kind:t,x:n.x,y:n.y,vx:0,vy:0,r:r.r,w:r.w,h:r.h,hp:r.hp,maxHp:r.hp,facing:0,lift:0,abductTime:r.t,abductable:r.abduct,destructible:!0,solid:!1,score:r.score,heat:r.heat,sprite:r.sprite,flash:0,dead:!1,flee:0,wanderT:t===`plane`?6:0,wanderA:Math.atan2(e.saucer.y-n.y,e.saucer.x-n.x),fireCd:.5+Math.random(),z:n.y})}function gu(e,n){if(!l(n.shouted))return;let a=typeof n.shouted==`number`?n.shouted:+!!n.shouted;n.shouted=a+1;let o=i(a);e.shouts.push({id:n.id,text:o,x:n.x,y:n.y,life:1.8,max:1.8}),iu(e,n.x,n.y-28,o);let s=Math.random();s<.34?r.scream():s<.67?r.cry():r.plea(),t.tap()}function _u(t,n){au(t,v,n.x,n.y),iu(t,n.x,n.y-48,s),t.shouts.push({id:t.saucer.id,text:s,x:t.saucer.x,y:t.saucer.y,life:2.4,max:2.4});let r=a();r.salvage+=8,e(r),t.bossTalk=3}function vu(e,t){let n=e.actors.find(e=>e.boss&&!e.dead);if(!n){e.bossTalk=3;return}e.bossTalk===0?(e.bossTalkT<=0&&!e.shouts.some(e=>e.text===`Hey buddy, what are you doing here?`)&&e.shouts.push({id:n.id,text:m,x:n.x,y:n.y,life:2.6,max:2.6}),e.bossTalkT+=t,e.bossTalkT>=2.4&&(e.shouts.push({id:e.saucer.id,text:o,x:e.saucer.x,y:e.saucer.y,life:2.4,max:2.4}),iu(e,e.saucer.x,e.saucer.y-36,o),e.bossTalk=1,e.bossTalkT=0)):e.bossTalk===1?(e.bossTalkT+=t,e.bossTalkT>=2.2&&(e.shouts.push({id:n.id,text:d,x:n.x,y:n.y,life:2,max:2}),iu(e,n.x,n.y-36,d),e.bossTalk=2,e.bossTalkT=0)):e.bossTalk===2&&(e.bossTalkT+=t,e.bossTalkT>=1.15&&(e.bossTalk=3,e.bossTalkT=0))}function yu(n,i=1){if(!(n.saucer.flash>0)){if((n.state.shield??0)>0){n.state.shield=Math.max(0,n.state.shield-i),n.saucer.flash=.45,n.state.shake=Math.min(1,n.state.shake+.4),r.hit();return}if(n.state.hp=Math.max(0,n.state.hp-i),n.saucer.hp=n.state.hp,n.saucer.flash=.7,n.state.shake=Math.min(1,n.state.shake+.7),r.hurt(),n.state.hp<=0){n.state.phase=`upgrade`,n.state.reason=`destroyed`,g(n.state.score);let i=S(a(),n.state.score,!1);e(i),r.explode(),t.gameOver()}}}function bu(e){let t=e.saucer,n=e.actors.filter(e=>e.kind===`special`&&!e.dead).sort((e,n)=>Math.hypot(e.x-t.x,e.y-t.y)-Math.hypot(n.x-t.x,n.y-t.y))[0];return n?(n.x=t.x+36,n.y=t.y+8,ou(e,n,`blast`),!0):!1}function xu(t,i=`start`){let o=a();i===`next`&&(o.level+=1,e(o));let s=_();Object.assign(t,s),t.state.phase=`playing`,t.state.timeLeft=n(a().level),t.state.score=0,r.ui()}function Su(e,n,i){let o=e.state;if(o.phase!==`playing`)return;if(e.time+=i,o.timeLeft-=i,o.timeLeft<=0){o.timeLeft=0,o.phase=`upgrade`,o.reason=`time`,g(o.score),S(a(),o.score,!0),t.gameOver();return}vu(e,i),o.comboTimer=Math.max(0,o.comboTimer-i),o.comboTimer===0&&(o.combo=0),o.heat=Math.max(0,o.heat-1.6*i),o.alert=u(o.heat),o.shake=Math.max(0,o.shake-i*1.8),o.cloakT=Math.max(0,(o.cloakT??0)-i),e.saucer.flash>0&&(e.saucer.flash-=i),(o.shieldMax??0)>0&&e.saucer.flash<=0&&o.shield<o.shieldMax&&(o.shield=Math.min(o.shieldMax,o.shield+i*.18));let s=e.saucer,d=n.moveX,p=n.moveY,m=(o.speed||330)*(n.beam?.72:1),_=d*m,v=p*m;if(s.vx+=(_-s.vx)*(1-Math.exp(-10*i)),s.vy+=(v-s.vy)*(1-Math.exp(-10*i)),s.knockX=(s.knockX??0)*Math.exp(-7*i),s.knockY=(s.knockY??0)*Math.exp(-7*i),s.x=tu(s.x+(s.vx+(s.knockX??0))*i,48,f-48),s.y=tu(s.y+(s.vy+(s.knockY??0))*i,48,h-48),d||p){let e=Math.atan2(p,d)-s.facing;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;s.facing+=e*(1-Math.exp(-8*i))}d<-.2&&(e.qaYaw+=2.4*i),d>.2&&(e.qaYaw-=2.4*i);let y=n.aimX,b=n.aimY;if(Math.hypot(y,b)<.15){let t=lu(e,s);t&&n.fire?(y=t.x-s.x,b=t.y-s.y):Math.hypot(s.vx,s.vy)>20?(y=s.vx,b=s.vy):(y=e.aimX,b=e.aimY)}let C=Math.hypot(y,b)||1;e.aimX=y/C,e.aimY=b/C,e.beamOn=n.beam,n.beam?(r.startBeam(),t.beam()):r.stopBeam(),e.fireCd=Math.max(0,e.fireCd-i),n.fire&&e.fireCd<=0&&(uu(e,e.aimX,e.aimY),e.fireCd=(o.fireRate||.085)*(1-Math.min(.4,(o.weaponTier??0)*.1)));let w=t=>e.actors.filter(e=>e.kind===t&&!e.dead&&!e.boss).length,T=o.alert,E=x(o.level||1,T);e.jeepCd-=i,e.tankCd-=i,e.heliCd-=i,e.planeCd-=i,w(`jeep`)<E.jeep&&e.jeepCd<=0&&(hu(e,`jeep`),e.jeepCd=E.jeepCd),w(`tank`)<E.tank&&e.tankCd<=0&&(hu(e,`tank`),e.tankCd=E.tankCd),w(`heli`)<E.heli&&e.heliCd<=0&&(hu(e,`heli`),e.heliCd=E.heliCd),w(`plane`)<E.plane&&e.planeCd<=0&&(hu(e,`plane`),e.planeCd=E.planeCd);let D=n.beam;for(let t of e.actors){if(t.dead)continue;t.z=t.y,t.flash>0&&(t.flash-=i),t.fireCd=Math.max(0,t.fireCd-i);let n=t.x-s.x,a=t.y-s.y,c=Math.hypot(n,a);if(D&&t.abductable&&c<(o.beamR||82)+t.r*.4?((t.kind===`farmer`||t.kind===`civilian`)&&l(t.shouted)&&(t.lift<=0||t.lift>t.abductTime*.45)&&gu(e,t),Ql(t,s.x,s.y,i,o.abductMul||1),nu(e,t.x+(Math.random()-.5)*16,t.y+10,(Math.random()-.5)*20,-80-Math.random()*40,.35,3,`#7dffc2`,0),t.lift>=t.abductTime&&ou(e,t,`abduct`)):t.lift=Math.max(0,t.lift-i*1.6),t.kind===`loot`){t.wanderT-=i,t.wanderT<=0&&(t.dead=!0),c<46&&fu(e,t);continue}if(t.kind===`rival`){let n=(o.cloakT??0)>0,a=e.bossTalk>=3,c=s.x-t.x,l=s.y-t.y,u=Math.hypot(c,l)||1;if(!a||n){t.wanderA+=i*.7;let e=Math.cos(t.wanderA)*40,n=Math.sin(t.wanderA)*40;t.vx+=(e-t.vx)*(1-Math.exp(-3*i)),t.vy+=(n-t.vy)*(1-Math.exp(-3*i)),t.facing=Math.atan2(s.y-t.y,s.x-t.x)}else t.vx+=(c/u*155-t.vx)*(1-Math.exp(-4*i)),t.vy+=(l/u*155-t.vy)*(1-Math.exp(-4*i)),t.facing=Math.atan2(l,c),t.fireCd<=0&&u<620&&(t.fireCd=1.55,pu(e,t.x,t.y,c,l,260,1,1.8),r.laser())}else if(t.kind===`jeep`||t.kind===`tank`){let n=(o.cloakT??0)>0,a=s.x-t.x,c=s.y-t.y,l=Math.hypot(a,c)||1,u=t.kind===`tank`?78:145;if(n)t.wanderT-=i,t.wanderT<=0&&(t.wanderT=1.4,t.wanderA=Math.random()*Math.PI*2),t.vx+=(Math.cos(t.wanderA)*40-t.vx)*(1-Math.exp(-3*i)),t.vy+=(Math.sin(t.wanderA)*40-t.vy)*(1-Math.exp(-3*i)),t.facing=Math.atan2(t.vy,t.vx);else{t.vx+=(a/l*u-t.vx)*(1-Math.exp(-5*i)),t.vy+=(c/l*u-t.vy)*(1-Math.exp(-5*i)),t.facing=Math.atan2(t.vy,t.vx);let n=t.kind===`tank`?580:520;t.fireCd<=0&&l<n&&(t.fireCd=t.kind===`tank`?1.85:1.15,pu(e,t.x,t.y,a,c,t.kind===`tank`?210:280,t.kind===`tank`?2:1),t.kind===`tank`&&r.tank())}}else if(t.kind===`heli`){let n=e.time*.85+t.id,a=s.x+Math.cos(n)*240-t.x,c=s.y+Math.sin(n)*240-t.y,l=Math.hypot(a,c)||1;t.vx+=(a/l*190-t.vx)*(1-Math.exp(-4*i)),t.vy+=(c/l*190-t.vy)*(1-Math.exp(-4*i)),t.facing=Math.atan2(s.y-t.y,s.x-t.x);let u=Math.hypot(s.x-t.x,s.y-t.y);(o.cloakT??0)<=0&&t.fireCd<=0&&u<480&&(t.fireCd=.72,pu(e,t.x,t.y,s.x-t.x,s.y-t.y,300,1,1.6),r.heli())}else if(t.kind===`plane`){let n=t.wanderA;t.vx=Math.cos(n)*340,t.vy=Math.sin(n)*340,t.facing=n,t.wanderT-=i,(o.cloakT??0)<=0&&t.fireCd<=0&&(t.fireCd=.38,pu(e,t.x,t.y,Math.cos(n),Math.sin(n),420,1,1.1),r.jet()),(t.wanderT<=0||t.x<-80||t.y<-80||t.x>4976||t.y>3680)&&(t.dead=!0)}else if(t.kind===`rubble`)t.spin=(t.spin??0)*Math.exp(-1.8*i);else if(t.kind===`cow`||t.kind===`pig`||t.kind===`sheep`||t.kind===`chicken`||t.kind===`farmer`||t.kind===`civilian`){if(c<220&&(t.flee=1.6),t.flee>0){t.flee-=i;let e=c||1,r=t.kind===`chicken`?95:t.kind===`cow`?55:80,o=n/e*r,s=a/e*r;t.vx+=(o-t.vx)*(1-Math.exp(-7*i)),t.vy+=(s-t.vy)*(1-Math.exp(-7*i))}else t.wanderT-=i,t.wanderT<=0&&(t.wanderT=1.2+Math.random()*2.4,t.wanderA=Math.random()*Math.PI*2),t.vx+=(Math.cos(t.wanderA)*22-t.vx)*(1-Math.exp(-4*i)),t.vy+=(Math.sin(t.wanderA)*22-t.vy)*(1-Math.exp(-4*i))}!Wl(t)&&t.kind!==`prop`&&Jl(t,i)}$l(e);for(let t of e.lasers){if(t.dead)continue;let n=t.x,a=t.y;if(t.x+=t.vx*i,t.y+=t.vy*i,t.wanderT-=i,t.wanderT<=0||t.x<0||t.y<0||t.x>4896||t.y>3600){t.dead=!0;continue}for(let i of e.actors){if(i.dead||!i.destructible||i.boss&&e.bossTalk<3||!eu(n,a,t.x,t.y,i.x,i.y,i.r+12))continue;t.dead=!0;let s=22*(o.laserMult||1)*(1+(o.weaponTier??0)*.28);c(i,s),i.flash=.08,Xl(i,t.vx*.08,t.vy*.08),r.hit(),ru(e,t.x,t.y,6,`#9dffc4`,90),i.hp<=0&&ou(e,i,`blast`);break}}for(let t of e.bullets){if(t.dead)continue;let n=t.x,r=t.y;if(t.x+=t.vx*i,t.y+=t.vy*i,t.wanderT-=i,t.wanderT<=0){t.dead=!0;continue}if(eu(n,r,t.x,t.y,s.x,s.y,s.r+8)){if(t.dead=!0,(o.cloakT??0)>0){ru(e,t.x,t.y,5,`#c9a0ff`,70);continue}let n=Math.hypot(t.vx,t.vy)||1;s.knockX=(s.knockX??0)+t.vx/n*220,s.knockY=(s.knockY??0)+t.vy/n*220,yu(e,t.dmg??1)}}e.lasers=e.lasers.filter(e=>!e.dead),e.bullets=e.bullets.filter(e=>!e.dead),e.actors=e.actors.filter(e=>!e.dead||e.kind===`rubble`);for(let t of e.particles)t.alive&&(t.life-=i,t.x+=t.vx*i,t.y+=t.vy*i,t.vy+=t.gravity*i,t.life<=0&&(t.alive=!1));for(let t of e.popups)t.life-=i,t.y-=28*i;e.popups=e.popups.filter(e=>e.life>0);for(let t of e.shouts){t.life-=i;let n=e.actors.find(e=>e.id===t.id);n&&!n.dead?(t.x=n.x,t.y=n.y-36-n.lift*40):t.y-=18*i}e.shouts=e.shouts.filter(e=>e.life>0);for(let t of e.explosions)t.t+=i;e.explosions=e.explosions.filter(e=>e.t<.45);let O=s.x+s.vx*.18,k=s.y+s.vy*.18;o.camX+=(O-o.camX)*(1-Math.exp(-7*i)),o.camY+=(k-o.camY)*(1-Math.exp(-7*i))}function Cu(e,t,n,r,i,a){let o=Tu(e);return{x:(t-e.state.camX)*a+r/2+o.x,y:(n-e.state.camY)*a+i/2+o.y}}function wu(e,t,n,r,i,a){let o=Tu(e);return{x:(t-r/2-o.x)/a+e.state.camX,y:(n-i/2-o.y)/a+e.state.camY}}function Tu(e){let t=e.state.shake*e.state.shake;return t<=0?{x:0,y:0}:{x:(Math.random()*2-1)*t*14,y:(Math.random()*2-1)*t*14}}function Eu(e){if(!e)return null;let t=new Wt(e);return t.colorSpace=rt,t.minFilter=k,t.magFilter=k,t.generateMipmaps=!1,t.needsUpdate=!0,t}function Du(e){return new Z(parseInt(e.replace(`#`,``),16))}function Ou(e){let t=new Tl({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`,stencil:!1,preserveDrawingBuffer:!0});t.setClearColor(1185807,1),t.outputColorSpace=rt,t.toneMapping=0,t.autoClear=!0;let n=new Nn;n.fog=new Mn(659478,55e-5);let r=new za(-200,200,200,-200,.1,1600);r.up.set(0,0,-1),r.position.set(0,520,0),r.lookAt(0,0,0),n.add(new wa(7177896,1840656,.85)),n.add(new Ha(2371648,.35));let i=new Va(9085128,.35);i.position.set(-200,400,-120),n.add(i);let a=new Ra(12120272,3.4,420,1.6);a.position.set(0,70,0),n.add(a);let o=new Ra(7330714,1.4,180,2);n.add(o);let s=[];for(let e=0;e<3;e++){let e=new Ra(16751178,0,280,2);n.add(e),s.push(e)}let c=new hi(new Yi(f+400,h+400),new ri({color:1713176}));c.rotation.x=-Math.PI/2,c.position.set(f/2,-1,h/2),n.add(c);let l=new wn;n.add(l);let u=[],d=null,p=new Yi(72.4,72.4);p.rotateX(-Math.PI/2);function m(e){for(let e of u)l.remove(e),e.geometry.dispose(),e.material.dispose();u.length=0;let t=[0,0,0,0];for(let n=0;n<e.terrain.length;n++)t[e.terrain[n]??0]++;let n=new Cn;for(let r=0;r<4;r++){let i=b.tile[r],a=new ri({map:Eu(i),color:16777215}),o=new Di(p,a,t[r]||1);o.frustumCulled=!1;let s=0;for(let t=0;t<50;t++)for(let i=0;i<68;i++)(e.terrain[t*68+i]??0)===r&&(n.position.set(i*72+36,0,t*72+36),n.updateMatrix(),o.setMatrixAt(s++,n.matrix));o.instanceMatrix.needsUpdate=!0,l.add(o),u.push(o)}d=e.terrain}let g=new Map;function _(e){let t=g.get(e);return t||(t=Eu(e.startsWith(`saucer`)?b.saucer[Number(e.slice(-1))-1]:e.startsWith(`explode`)?b.explode[Number(e.slice(-1))-1]:e.startsWith(`laser`)?b.laser[Number(e.slice(-1))-1]:b.sprite[e])??new Wt,g.set(e,t),t)}let v=new Map,y=new Map;function x(e,t=!1){let n=e+(t?`:add`:``),r=y.get(n);return r||(r=new Nr({map:_(e),transparent:!0,depthWrite:!1,color:16777215,blending:t?2:1}),y.set(n,r),r)}function S(e,t,r=!1){let i=v.get(e);return i?i.material.map!==x(t,r).map&&(i.material=x(t,r)):(i=new qr(x(t,r)),i.center.set(.5,.45),n.add(i),v.set(e,i)),i.visible=!0,i}let C=new Float32Array(1200),w=new Float32Array(1200),T=new Float32Array(400),E=new Dr;E.setAttribute(`position`,new fr(C,3)),E.setAttribute(`color`,new fr(w,3)),E.setAttribute(`size`,new fr(T,1));let D=new Ii({size:5,vertexColors:!0,transparent:!0,depthWrite:!1,blending:2,sizeAttenuation:!0}),O=new Vi(E,D);O.frustumCulled=!1,n.add(O);let k=new Ji(78,32);k.rotateX(-Math.PI/2);let A=new ri({color:8257474,transparent:!0,opacity:.22,blending:2,depthWrite:!1}),ee=new hi(k,A);ee.visible=!1,n.add(ee);let j=new Xi(62,70,40);j.rotateX(-Math.PI/2);let te=new hi(j,new ri({color:11993056,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:2}));n.add(te);let M=null,ne=()=>!1;function N(){M?.dispose();let i=new Pl(t);i.addPass(new Fl(n,r));let a=new Ll(new K(e.width,e.height),.42,.7,.82);i.addPass(a),i.addPass(new zl),M=i}let P=new Set,re=()=>{let n=Math.min(e.clientWidth<500?1.35:1.75,window.devicePixelRatio||1),r=Math.max(1,e.clientWidth),i=Math.max(1,e.clientHeight);t.setPixelRatio(n),t.setSize(r,i,!1),M?.setSize(r,i),ne()&&!M&&N(),ne()||(M=null)};re();let ie=new Z;return{resize:re,render(i,c){d!==i.terrain&&m(i);let l=e.clientWidth,u=e.clientHeight,f=l>u?u/380:l/400;i.state.camZoom=f;let p=u/f,h=l/f;r.left=-h/2,r.right=h/2,r.top=p/2,r.bottom=-p/2,r.updateProjectionMatrix();let g=Tu(i),_=i.state.camX+g.x/f,y=i.state.camY+g.y/f;r.position.set(_,520,y),r.lookAt(_,0,y);let b=i.saucer;a.position.set(b.x,78,b.y),a.intensity=i.beamOn?5.2:3.1,o.position.set(b.x,40,b.y),o.intensity=i.beamOn?2.4:1.1;let x=.55+Math.sin(c*.014)*.12;ee.visible=i.beamOn,te.visible=i.beamOn,i.beamOn&&(ee.position.set(b.x,1.4,b.y+8),ee.scale.setScalar(.92+x*.18),A.opacity=.16+x*.14,te.position.set(b.x,1.8,b.y+8),te.material.opacity=.22+x*.2);for(let e=0;e<s.length;e++){let t=i.explosions[e],n=s[e];if(!t){n.intensity=0;continue}n.position.set(t.x,36,t.y),n.intensity=(1-t.t/.45)*8}P.clear();let D=Math.sin(c*.006)*4,O=Math.floor(c/140)%4,k=S(-1,Bl(i.state.craftId,i.saucer.sprite,O));k.position.set(b.x,18+D,b.y),k.scale.set(b.w,b.h,1),k.material.rotation=i.state.craftId===`disc`?0:-b.facing;let j=(i.state.cloakT??0)>0;k.material.opacity=j?.28+x*.22:b.flash>0&&Math.floor(c/70)%2==0?.5:1,a.color.setHex(j?13213951:12120272),o.color.setHex(j?10121440:7330714),k.renderOrder=b.y+400,P.add(-1);let N=_-h/2-120,re=_+h/2+120,ae=y-p/2-120,oe=y+p/2+120;for(let e of i.actors){if(e.dead&&e.kind!==`rubble`||e.x<N||e.x>re||e.y<ae||e.y>oe)continue;let t=e.kind===`rubble`?e.sprite:e.propKey?e.propKey:e.sprite,n=S(e.id,t),r=e.lift>0?Math.min(36,e.lift*48):0,i=e.kind===`loot`?6+Math.sin(c*.008+e.id)*5:e.abductable?Math.sin(c*.004+e.id)*1.2:0;n.position.set(e.x,8+r+i,e.y);let a=e.kind===`loot`?1+Math.sin(c*.01)*.12:1;n.scale.set(e.w*a,e.h*a,1),n.material.rotation=e.kind===`jeep`||e.kind===`tank`||e.kind===`heli`||e.kind===`plane`||e.kind===`rival`||e.spin?-e.facing:0,n.material.opacity=e.kind===`rubble`?.9:e.flash>0?.75:1,n.material.color.setHex((e.flash,16777215)),n.renderOrder=e.y,P.add(e.id)}let se=0;for(let e of i.lasers){let t=S(e.id,`laser-${se++%4+1}`,!0);t.position.set(e.x,14,e.y),t.scale.set(34,16,1),t.material.rotation=-e.facing,t.renderOrder=e.y+200,P.add(e.id)}for(let e of i.bullets){let t=S(e.id,`laser-1`,!0);t.position.set(e.x,12,e.y),t.scale.set(10,10,1),t.material.color.setHex(16738880),t.renderOrder=e.y+180,P.add(e.id)}for(let e of i.explosions){let t=Math.min(3,Math.floor(e.t/.45*4)),n=S(9e5+(e.x|0)+(e.y|0),`explode-${t+1}`,!0),r=90*e.scale*(.85+e.t);n.position.set(e.x,20,e.y),n.scale.set(r,r,1),n.material.opacity=1-e.t*.45,n.renderOrder=e.y+300,P.add(9e5+(e.x|0)+(e.y|0))}for(let[e,t]of v)P.has(e)||(t.visible=!1);let F=0;for(let e of i.particles){if(!e.alive||F>=400)continue;let t=F*3;C[t]=e.x,C[t+1]=10+e.size,C[t+2]=e.y,ie.copy(Du(e.color));let n=Math.max(0,e.life/e.max);w[t]=ie.r*n,w[t+1]=ie.g*n,w[t+2]=ie.b*n,T[F]=e.size*2.2,F++}for(let e=F;e<400;e++)C[e*3+1]=-40,T[e]=0;E.getAttribute(`position`).needsUpdate=!0,E.getAttribute(`color`).needsUpdate=!0,E.getAttribute(`size`).needsUpdate=!0,E.setDrawRange(0,F),M&&ne()?M.render():t.render(n,r)},dispose(){M?.dispose(),t.dispose(),p.dispose(),k.dispose(),j.dispose(),E.dispose(),D.dispose();for(let e of u)e.material.dispose();for(let e of y.values())e.dispose();for(let e of g.values())e.dispose()}}}var ku=1/60;function Au(e,t,n){let i=0,o=performance.now(),s=0,c=0,l=!0,u=t.state.phase,d=Ou(e),m=()=>{d.resize()};m();let g=new ResizeObserver(m);g.observe(e),window.addEventListener(`orientationchange`,m),window.visualViewport?.addEventListener(`resize`,m),window.__controlsTest={getYaw:()=>t.qaYaw,getSpeed:()=>Math.hypot(t.saucer.vx,t.saucer.vy),getX:()=>t.saucer.x,getY:()=>t.saucer.y,setKeys:e=>n.setKeys(e),setSteer:e=>n.setSteer(e),restart:()=>{n.reset(),xu(t,`retry`),o=performance.now(),s=0,_()},getMove:()=>({x:n.actions.moveX,y:n.actions.moveY}),smashNearestSpecial:()=>bu(t),getLoot:()=>t.actors.filter(e=>e.kind===`loot`&&!e.dead).length,getTier:()=>t.state.weaponTier,getCloak:()=>t.state.cloakT,getLevel:()=>t.state.level,endSector:()=>{t.state.timeLeft=.05}};let _=()=>{let n=t.state,r=t.state.camZoom||1,i=[{x:t.saucer.x/f,y:t.saucer.y/h,t:`you`}];for(let e of t.actors)e.dead||(e.kind===`special`?i.push({x:e.x/f,y:e.y/h,t:e.loot===`cloak`?`cloak`:`gun`}):e.kind===`loot`?i.push({x:e.x/f,y:e.y/h,t:`loot`}):e.kind===`rival`?i.push({x:e.x/f,y:e.y/h,t:`jeep`}):(e.kind===`jeep`||e.kind===`tank`||e.kind===`heli`||e.kind===`plane`)&&i.push({x:e.x/f,y:e.y/h,t:e.kind}));let o=a();y({phase:n.phase,score:n.score,combo:n.combo,heat:n.heat,timeLeft:n.timeLeft,hp:n.hp,maxHp:n.maxHp,abducted:n.stats.abducted,destroyed:n.stats.destroyed,best:Math.max(p(),n.score),stats:n.stats,reason:n.reason,alert:n.alert,...n.phase===`playing`?{craftId:n.craftId||`disc`}:{},shouts:(t.shouts??[]).map(n=>{let i=Cu(t,n.x,n.y,e.clientWidth,e.clientHeight,r);return{...n,x:i.x,y:i.y}}),weaponTier:n.weaponTier??0,cloakT:n.cloakT??0,level:n.level||o.level,salvage:o.salvage,shield:n.shield??0,shieldMax:n.shieldMax??0,marks:i})},v=a=>{if(!l)return;let f=(a-o)/1e3;if(o=a,f>.1&&(f=.1),n.update(),n.hasMouseAim&&!n.sticks.some(e=>e.kind===`aim`)){let r=t.state.camZoom||1,i=wu(t,n.mouseX,n.mouseY,e.clientWidth,e.clientHeight,r),a=i.x-t.saucer.x,o=i.y-t.saucer.y,s=Math.hypot(a,o);s>8&&(n.actions.aimX=a/s,n.actions.aimY=o/s)}for(t.state.phase===`playing`&&n.justPause?(t.state.phase=`paused`,r.stopBeam(),_()):t.state.phase===`paused`&&n.justPause&&(t.state.phase=`playing`,_()),s+=f;s>=ku;)t.state.phase===`playing`&&(t.state.hitstop>0?t.state.hitstop-=ku:Su(t,n.actions,ku)),s-=ku;u===`playing`&&t.state.phase!==`playing`&&t.state.phase!==`paused`&&n.reset(),u=t.state.phase,d.render(t,a),c+=f,c>.08&&(c=0,_()),i=requestAnimationFrame(v)};return i=requestAnimationFrame(v),_(),{world:t,destroy(){l=!1,cancelAnimationFrame(i),g.disconnect(),window.removeEventListener(`orientationchange`,m),window.visualViewport?.removeEventListener(`resize`,m),r.stopBeam(),d.dispose(),delete window.__controlsTest},start(e=`start`){n.reset(),r.unlock(),xu(t,e),o=performance.now(),s=0,_()},pause(){t.state.phase===`playing`&&(t.state.phase=`paused`),_()},resume(){t.state.phase===`paused`&&(t.state.phase=`playing`),_()}}}export{Au as runGame};