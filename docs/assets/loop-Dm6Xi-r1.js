...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){let r=new Float32Array(xo),i=new q(0,1,0);return new ra({name:`SphericalGaussianBlur`,defines:{n:xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(){return new ra({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new ra({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Fl.BlurDirectionX=new K(1,0),Fl.BlurDirectionY=new K(0,1);var Il={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Ll=class extends Tl{constructor(){super(),this.isOutputPass=!0,this.uniforms=ea.clone(Il.uniforms),this.material=new ia({name:Il.name,uniforms:this.uniforms,vertexShader:Il.vertexShader,fragmentShader:Il.fragmentShader}),this._fsQuad=new Ol(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function Rl(e,t,n){return e&&e!==`disc`?t:`saucer-${n%4+1}`}var zl=96,Bl={saucer:14,cow:5,pig:3.4,sheep:2.8,chicken:.9,farmer:2.4,civilian:2.2,tractor:9,pickup:7,sedan:5.5,jeep:8,tank:18,heli:6,plane:5,barn:0,farmhouse:0,townhouse:0,shop:0,silo:0,special:0,loot:.4,prop:0,rubble:2.2,laser:.2,bullet:.15};function Vl(e){if(e.invMass!=null)return e.invMass;let t=e.mass??Bl[e.kind]??2;return t>0?1/t:0}function Hl(e){return Vl(e)===0}function Ul(e,t){return e+512<<16|t+512&65535}function Wl(e,t){let n=Ul(Math.floor(t.x/zl),Math.floor(t.y/zl)),r=e.get(n);r||(r=[],e.set(n,r)),r.push(t)}function Gl(e,t,n,r,i){i.length=0;let a=Math.floor((t+r)/zl),o=Math.floor((t-r)/zl),s=Math.floor((n+r)/zl),c=Math.floor((n-r)/zl);for(let t=c;t<=s;t++)for(let n=o;n<=a;n++){let r=e.get(Ul(n,t));if(r)for(let e of r)i.push(e)}return i}function Kl(e,t){let n=e.drag??(e.kind===`rubble`?2.4:1.6),r=Math.exp(-n*t);e.vx*=r,e.vy*=r,e.x+=e.vx*t,e.y+=e.vy*t,e.spin&&(e.facing+=e.spin*t),e.x<36?(e.x=36,e.vx=Math.abs(e.vx)*(e.restitution??.2)):e.x>4860&&(e.x=o-36,e.vx=-Math.abs(e.vx)*(e.restitution??.2)),e.y<36?(e.y=36,e.vy=Math.abs(e.vy)*(e.restitution??.2)):e.y>3564&&(e.y=a-36,e.vy=-Math.abs(e.vy)*(e.restitution??.2))}function ql(e,t){let n=Vl(e),r=Vl(t);if(n===0&&r===0)return;let i=t.x-e.x,a=t.y-e.y,o=e.r+t.r,s=i*i+a*a;if(s>o*o||s<1e-8)return;let c=Math.sqrt(s),l=i/c,u=a/c,d=o-c,f=n+r;e.x-=l*d*(n/f),e.y-=u*d*(n/f),t.x+=l*d*(r/f),t.y+=u*d*(r/f);let p=t.vx-e.vx,m=t.vy-e.vy,h=p*l+m*u;if(h>0)return;let g=-(1+Math.min(e.restitution??.15,t.restitution??.15))*h/f;e.vx-=g*l*n,e.vy-=g*u*n,t.vx+=g*l*r,t.vy+=g*u*r}function Jl(e,t,n){let r=Vl(e);r!==0&&(e.vx+=t*r,e.vy+=n*r)}function Yl(e,t,n,r,i){let a=r*r;for(let o of e.actors){if(o.dead&&o.kind!==`rubble`)continue;let e=o.x-t,s=o.y-n,c=e*e+s*s;if(c>a||c<1)continue;let l=Math.sqrt(c),u=1-l/r;Jl(o,e/l*i*u,s/l*i*u),o.spin=(o.spin??0)+(Math.random()-.5)*8*u,o.flee=Math.max(o.flee,1.1)}let o=e.saucer,s=o.x-t,c=o.y-n,l=s*s+c*c;if(l<a&&l>1){let e=Math.sqrt(l),t=1-e/r;o.knockX=(o.knockX??0)+s/e*90*t,o.knockY=(o.knockY??0)+c/e*90*t}}function Xl(e,t,n,r,i=1){let a=(t-e.x)*22-e.vx*6,o=(n-16-e.y)*22-e.vy*6;Jl(e,a*r*18,o*r*18),e.lift+=r*i}function Zl(e){let t=new Map;for(let n of e.actors)n.dead&&n.kind!==`rubble`||Wl(t,n);let n=[];for(let r of e.actors)if(!(r.dead&&r.kind!==`rubble`)&&!Hl(r)){Gl(t,r.x,r.y,r.r+48,n);for(let e of n)e.id<=r.id||e.dead&&e.kind!==`rubble`||!r.solid&&!e.solid&&r.kind!==`rubble`&&e.kind!==`rubble`&&(!r.abductable||!e.abductable)||ql(r,e)}}function Ql(e,t,n,r,i,a,o){let s=n-e,c=r-t,l=e-i,u=t-a,d=s*s+c*c,f=2*(l*s+u*c),p=l*l+u*u-o*o;if(d<1e-8)return p<=0;let m=f*f-4*d*p;if(m<0)return!1;m=Math.sqrt(m);let h=(-f-m)/(2*d),g=(-f+m)/(2*d);return h>=0&&h<=1||g>=0&&g<=1||h<0&&g>1}function $l(e,t,n){return Math.max(t,Math.min(n,e))}function eu(e,t,n,r,i,a,o,s,c=0){let l=e.particles.find(e=>!e.alive);l&&(l.alive=!0,l.x=t,l.y=n,l.vx=r,l.vy=i,l.life=a,l.max=a,l.size=o,l.color=s,l.gravity=c)}function tu(e,t,n,r,i,a=180){for(let o=0;o<r;o++){let r=Math.random()*Math.PI*2,o=a*(.35+Math.random());eu(e,t,n,Math.cos(r)*o,Math.sin(r)*o,.35+Math.random()*.45,2+Math.random()*4,i,40)}}function nu(e,t,n,r){e.popups.push({x:t,y:n,text:r,life:.9,max:.9})}function ru(e,t,n,r){let i=e.state;i.comboTimer>0?i.combo+=1:i.combo=1,i.comboTimer=2.3,i.stats.maxCombo=Math.max(i.stats.maxCombo,i.combo);let a=Math.min(6,1+Math.floor((i.combo-1)/2)),o=t*a;i.score+=o,nu(e,n,r-20,a>1?`+${o}  ×${a}`:`+${o}`)}function iu(e,n,r){if(!n.dead){if(n.dead=!0,r===`abduct`)au(e,n),t.abduct(),tu(e,n.x,n.y,14,`#7dffb2`,140),tu(e,n.x,n.y,8,`#e8ffe8`,80);else if(ou(e,n),t.explode(),e.explosions.push({x:n.x,y:n.y,t:0,scale:n.r>40?1.6:1}),tu(e,n.x,n.y,22,`#ffb060`,260),tu(e,n.x,n.y,10,`#3a2a22`,120),Yl(e,n.x,n.y,n.r>40?240:150,n.r>40?980:520),e.state.shake=Math.min(1,e.state.shake+(n.r>40?.55:.32)),e.state.hitstop=n.r>40?.05:.03,n.destructible&&n.kind!==`prop`&&n.kind!==`loot`){let t=n.r>40?5:3;for(let r=0;r<t;r++){let i=Math.PI*2*r/t+Math.random()*.4,a=80+Math.random()*160;e.actors.push({...n,id:n.id+9e4+r,kind:`rubble`,sprite:`rubble-${1+(n.id+r)%4}`,hp:1,dead:!1,destructible:!1,abductable:!1,solid:!1,w:n.w*(.28+Math.random()*.25),h:n.h*(.22+Math.random()*.2),r:n.r*.28,x:n.x+Math.cos(i)*10,y:n.y+Math.sin(i)*10,vx:Math.cos(i)*a,vy:Math.sin(i)*a,spin:(Math.random()-.5)*10,mass:1.6,invMass:1/1.6,restitution:.25,drag:2.2})}}e.state.heat=$l(e.state.heat+n.heat*(e.state.heatMult||1),0,100),e.state.alert=m(e.state.heat),r===`blast`&&n.kind===`special`&&lu(e,n)}}function au(e,t){let n=e.state.stats;n.abducted+=1,(t.kind===`cow`||t.kind===`pig`||t.kind===`sheep`||t.kind===`chicken`)&&(n.cows+=1),(t.kind===`farmer`||t.kind===`civilian`)&&(n.people+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`||t.kind===`tank`||t.kind===`heli`||t.kind===`plane`)&&(n.vehicles+=1),ru(e,t.score,t.x,t.y),t.boss&&hu(e,t)}function ou(e,t){let n=e.state.stats;n.destroyed+=1,(t.kind===`barn`||t.kind===`farmhouse`||t.kind===`townhouse`||t.kind===`shop`||t.kind===`silo`||t.kind===`special`)&&(n.buildings+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`||t.kind===`tank`||t.kind===`heli`||t.kind===`plane`)&&(n.vehicles+=1),ru(e,Math.round(t.score*.85),t.x,t.y),t.boss&&hu(e,t)}function su(e,t){let n=null,r=320;for(let i of e.actors){if(i.dead||!i.destructible&&!i.abductable||i.kind===`rubble`)continue;let e=Math.hypot(i.x-t.x,i.y-t.y);e<r&&(r=e,n=i)}return n}function cu(e,n,r){let i=Math.hypot(n,r)||1;n/=i,r/=i;let a=e.saucer,o=e.state.weaponTier??0,s=[[n,r]];if(o>=2&&(-r*14,n*14,s.length=0,s.push([n,r]),s.push([n,r])),o>=3){let e=Math.atan2(r,n);s.length=0;for(let t of[-.28,0,.28])s.push([Math.cos(e+t),Math.sin(e+t)])}else o>=2&&(s.length=0,s.push([n,r],[n,r]));let c=o===2;s.forEach((t,i)=>{let o=c?-r*(i===0?-12:12):0,s=c?n*(i===0?-12:12):0;e.lasers.push({id:8e4+e.lasers.length+i,kind:`laser`,x:a.x+t[0]*36+o,y:a.y+t[1]*36+s,vx:t[0]*680,vy:t[1]*680,r:8,w:22,h:10,hp:1,maxHp:1,facing:Math.atan2(t[1],t[0]),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`laser`,flash:0,dead:!1,flee:0,wanderT:.7,wanderA:0,fireCd:0,z:a.y})}),t.laser(),e.state.shake=Math.min(1,e.state.shake+.08)}function lu(e,t){let n=t.loot??(Math.random()<.5?`weapon`:`cloak`);e.actors.push({id:5e4+Math.floor(Math.random()*9e3),kind:`loot`,x:t.x,y:t.y,vx:0,vy:0,r:18,w:36,h:36,hp:1,maxHp:1,facing:0,lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:n===`weapon`?`pickup-weapon`:`pickup-cloak`,flash:0,dead:!1,flee:0,wanderT:18,wanderA:0,fireCd:0,z:t.y,loot:n}),nu(e,t.x,t.y-24,n===`weapon`?`WEAPON CACHE`:`CLOAK`)}function uu(n,r){r.dead||(r.dead=!0,r.loot===`weapon`?(n.state.weaponTier=Math.min(3,(n.state.weaponTier??0)+1),nu(n,r.x,r.y-20,[`Laser`,`Laser+`,`Twin`,`Spread`][n.state.weaponTier]),t.upgrade()):(n.state.cloakT=Math.min(16,(n.state.cloakT??0)+10),nu(n,r.x,r.y-20,`CLOAK`),t.cloak()),tu(n,r.x,r.y,16,r.loot===`weapon`?`#ffb060`:`#c9a0ff`,160),e.tap())}function du(e,t,n,r,i,a,o,s=2.1){let c=Math.hypot(r,i)||1;r/=c,i/=c,e.bullets.push({id:6e4+e.bullets.length+Math.floor(Math.random()*500),kind:`bullet`,x:t+r*28,y:n+i*28,vx:r*a,vy:i*a,r:6+o,w:10,h:10,hp:1,maxHp:1,facing:Math.atan2(i,r),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`bullet`,flash:0,dead:!1,flee:0,wanderT:s,wanderA:0,fireCd:0,z:n,dmg:o,mass:.15,invMass:1/.15})}function fu(){let e=Math.floor(Math.random()*4);return e===0?{x:Math.random()*o,y:60}:e===1?{x:o-60,y:Math.random()*a}:e===2?{x:Math.random()*o,y:a-60}:{x:60,y:Math.random()*a}}function pu(e,t){let n=fu(),r={jeep:{r:26,w:64,h:40,hp:70,score:480,heat:3,abduct:!0,t:1.2,sprite:`jeep`},tank:{r:34,w:86,h:48,hp:160,score:900,heat:4,abduct:!0,t:1.8,sprite:`tank`},heli:{r:30,w:72,h:64,hp:90,score:760,heat:3,abduct:!1,t:0,sprite:`heli`},plane:{r:28,w:88,h:56,hp:80,score:820,heat:3,abduct:!1,t:0,sprite:`plane`}}[t];e.actors.push({id:7e4+Math.floor(Math.random()*9999),kind:t,x:n.x,y:n.y,vx:0,vy:0,r:r.r,w:r.w,h:r.h,hp:r.hp,maxHp:r.hp,facing:0,lift:0,abductTime:r.t,abductable:r.abduct,destructible:!0,solid:!1,score:r.score,heat:r.heat,sprite:r.sprite,flash:0,dead:!1,flee:0,wanderT:t===`plane`?6:0,wanderA:Math.atan2(e.saucer.y-n.y,e.saucer.x-n.x),fireCd:.5+Math.random(),z:n.y})}function mu(n,r){if(!d(r.shouted))return;r.shouted=(typeof r.shouted==`number`?r.shouted:+!!r.shouted)+1;let i=_[Math.floor(Math.random()*_.length)];n.shouts.push({id:r.id,text:i,x:r.x,y:r.y,life:1.8,max:1.8}),nu(n,r.x,r.y-28,i);let a=Math.random();a<.34?t.scream():a<.67?t.cry():t.plea(),e.tap()}function hu(e,t){ru(e,i,t.x,t.y),nu(e,t.x,t.y-48,u),e.shouts.push({id:e.saucer.id,text:u,x:e.saucer.x,y:e.saucer.y,life:2.4,max:2.4});let a=n();a.salvage+=8,r(a),e.bossTalk=2}function gu(e,t){let n=e.actors.find(e=>e.boss&&!e.dead);if(!n){e.bossTalk=2;return}e.bossTalk===0?(e.bossTalkT<=0&&!e.shouts.some(e=>e.text===`Hey buddy, what are you doing here?`)&&e.shouts.push({id:n.id,text:l,x:n.x,y:n.y,life:2.4,max:2.4}),e.bossTalkT+=t,e.bossTalkT>=1.85&&(e.shouts.push({id:e.saucer.id,text:p,x:e.saucer.x,y:e.saucer.y,life:2.2,max:2.2}),nu(e,e.saucer.x,e.saucer.y-36,p),e.bossTalk=1,e.bossTalkT=0)):e.bossTalk===1&&(e.bossTalkT+=t,e.bossTalkT>=1.55&&(e.bossTalk=2,e.bossTalkT=0))}function _u(i,a=1){if(!(i.saucer.flash>0)){if((i.state.shield??0)>0){i.state.shield=Math.max(0,i.state.shield-a),i.saucer.flash=.45,i.state.shake=Math.min(1,i.state.shake+.4),t.hit();return}if(i.state.hp=Math.max(0,i.state.hp-a),i.saucer.hp=i.state.hp,i.saucer.flash=.7,i.state.shake=Math.min(1,i.state.shake+.7),t.hurt(),i.state.hp<=0){i.state.phase=`upgrade`,i.state.reason=`destroyed`,h(i.state.score);let a=s(n(),i.state.score,!1);r(a),t.explode(),e.gameOver()}}}function vu(e){let t=e.saucer,n=e.actors.filter(e=>e.kind===`special`&&!e.dead).sort((e,n)=>Math.hypot(e.x-t.x,e.y-t.y)-Math.hypot(n.x-t.x,n.y-t.y))[0];return n?(n.x=t.x+36,n.y=t.y+8,iu(e,n,`blast`),!0):!1}function yu(e,i=`start`){let a=n();i===`next`&&(a.level+=1,r(a));let o=g();Object.assign(e,o),e.state.phase=`playing`,e.state.timeLeft=b(n().level),e.state.score=0,t.ui()}function bu(r,i,c){let l=r.state;if(l.phase!==`playing`)return;if(r.time+=c,l.timeLeft-=c,l.timeLeft<=0){l.timeLeft=0,l.phase=`upgrade`,l.reason=`time`,h(l.score),s(n(),l.score,!0),e.gameOver();return}gu(r,c),l.comboTimer=Math.max(0,l.comboTimer-c),l.comboTimer===0&&(l.combo=0),l.heat=Math.max(0,l.heat-1.6*c),l.alert=m(l.heat),l.shake=Math.max(0,l.shake-c*1.8),l.cloakT=Math.max(0,(l.cloakT??0)-c),r.saucer.flash>0&&(r.saucer.flash-=c),(l.shieldMax??0)>0&&r.saucer.flash<=0&&l.shield<l.shieldMax&&(l.shield=Math.min(l.shieldMax,l.shield+c*.18));let u=r.saucer,f=i.moveX,p=i.moveY,g=(l.speed||330)*(i.beam?.72:1),_=f*g,y=p*g;if(u.vx+=(_-u.vx)*(1-Math.exp(-10*c)),u.vy+=(y-u.vy)*(1-Math.exp(-10*c)),u.knockX=(u.knockX??0)*Math.exp(-7*c),u.knockY=(u.knockY??0)*Math.exp(-7*c),u.x=$l(u.x+(u.vx+(u.knockX??0))*c,48,o-48),u.y=$l(u.y+(u.vy+(u.knockY??0))*c,48,a-48),f||p){let e=Math.atan2(p,f)-u.facing;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;u.facing+=e*(1-Math.exp(-8*c))}f<-.2&&(r.qaYaw+=2.4*c),f>.2&&(r.qaYaw-=2.4*c);let b=i.aimX,x=i.aimY;if(Math.hypot(b,x)<.15){let e=su(r,u);e&&i.fire?(b=e.x-u.x,x=e.y-u.y):Math.hypot(u.vx,u.vy)>20?(b=u.vx,x=u.vy):(b=r.aimX,x=r.aimY)}let S=Math.hypot(b,x)||1;r.aimX=b/S,r.aimY=x/S,r.beamOn=i.beam,i.beam?(t.startBeam(),e.beam()):t.stopBeam(),r.fireCd=Math.max(0,r.fireCd-c),i.fire&&r.fireCd<=0&&(cu(r,r.aimX,r.aimY),r.fireCd=(l.fireRate||.085)*(1-Math.min(.4,(l.weaponTier??0)*.1)));let C=e=>r.actors.filter(t=>t.kind===e&&!t.dead&&!t.boss).length,w=l.alert,T=v(l.level||1,w);r.jeepCd-=c,r.tankCd-=c,r.heliCd-=c,r.planeCd-=c,C(`jeep`)<T.jeep&&r.jeepCd<=0&&(pu(r,`jeep`),r.jeepCd=T.jeepCd),C(`tank`)<T.tank&&r.tankCd<=0&&(pu(r,`tank`),r.tankCd=T.tankCd),C(`heli`)<T.heli&&r.heliCd<=0&&(pu(r,`heli`),r.heliCd=T.heliCd),C(`plane`)<T.plane&&r.planeCd<=0&&(pu(r,`plane`),r.planeCd=T.planeCd);let E=i.beam;for(let e of r.actors){if(e.dead)continue;e.z=e.y,e.flash>0&&(e.flash-=c),e.fireCd=Math.max(0,e.fireCd-c);let n=e.x-u.x,i=e.y-u.y,a=Math.hypot(n,i);if(E&&e.abductable&&a<(l.beamR||82)+e.r*.4?((e.kind===`farmer`||e.kind===`civilian`)&&d(e.shouted)&&(e.lift<=0||e.lift>e.abductTime*.45)&&mu(r,e),Xl(e,u.x,u.y,c,l.abductMul||1),eu(r,e.x+(Math.random()-.5)*16,e.y+10,(Math.random()-.5)*20,-80-Math.random()*40,.35,3,`#7dffc2`,0),e.lift>=e.abductTime&&iu(r,e,`abduct`)):e.lift=Math.max(0,e.lift-c*1.6),e.kind===`loot`){e.wanderT-=c,e.wanderT<=0&&(e.dead=!0),a<46&&uu(r,e);continue}if(e.kind===`rival`){let n=(l.cloakT??0)>0,i=r.bossTalk>=2,a=u.x-e.x,o=u.y-e.y,s=Math.hypot(a,o)||1;if(!i||n){e.wanderA+=c*.7;let t=Math.cos(e.wanderA)*40,n=Math.sin(e.wanderA)*40;e.vx+=(t-e.vx)*(1-Math.exp(-3*c)),e.vy+=(n-e.vy)*(1-Math.exp(-3*c)),e.facing=Math.atan2(u.y-e.y,u.x-e.x)}else e.vx+=(a/s*155-e.vx)*(1-Math.exp(-4*c)),e.vy+=(o/s*155-e.vy)*(1-Math.exp(-4*c)),e.facing=Math.atan2(o,a),e.fireCd<=0&&s<620&&(e.fireCd=1.15,du(r,e.x,e.y,a,o,260,1,1.8),t.laser())}else if(e.kind===`jeep`||e.kind===`tank`){let n=(l.cloakT??0)>0,i=u.x-e.x,a=u.y-e.y,o=Math.hypot(i,a)||1,s=e.kind===`tank`?78:145;if(n)e.wanderT-=c,e.wanderT<=0&&(e.wanderT=1.4,e.wanderA=Math.random()*Math.PI*2),e.vx+=(Math.cos(e.wanderA)*40-e.vx)*(1-Math.exp(-3*c)),e.vy+=(Math.sin(e.wanderA)*40-e.vy)*(1-Math.exp(-3*c)),e.facing=Math.atan2(e.vy,e.vx);else{e.vx+=(i/o*s-e.vx)*(1-Math.exp(-5*c)),e.vy+=(a/o*s-e.vy)*(1-Math.exp(-5*c)),e.facing=Math.atan2(e.vy,e.vx);let n=e.kind===`tank`?580:520;e.fireCd<=0&&o<n&&(e.fireCd=e.kind===`tank`?1.85:1.15,du(r,e.x,e.y,i,a,e.kind===`tank`?210:280,e.kind===`tank`?2:1),e.kind===`tank`&&t.tank())}}else if(e.kind===`heli`){let n=r.time*.85+e.id,i=u.x+Math.cos(n)*240-e.x,a=u.y+Math.sin(n)*240-e.y,o=Math.hypot(i,a)||1;e.vx+=(i/o*190-e.vx)*(1-Math.exp(-4*c)),e.vy+=(a/o*190-e.vy)*(1-Math.exp(-4*c)),e.facing=Math.atan2(u.y-e.y,u.x-e.x);let s=Math.hypot(u.x-e.x,u.y-e.y);(l.cloakT??0)<=0&&e.fireCd<=0&&s<480&&(e.fireCd=.72,du(r,e.x,e.y,u.x-e.x,u.y-e.y,300,1,1.6),t.heli())}else if(e.kind===`plane`){let n=e.wanderA;e.vx=Math.cos(n)*340,e.vy=Math.sin(n)*340,e.facing=n,e.wanderT-=c,(l.cloakT??0)<=0&&e.fireCd<=0&&(e.fireCd=.38,du(r,e.x,e.y,Math.cos(n),Math.sin(n),420,1,1.1),t.jet()),(e.wanderT<=0||e.x<-80||e.y<-80||e.x>4976||e.y>3680)&&(e.dead=!0)}else if(e.kind===`rubble`)e.spin=(e.spin??0)*Math.exp(-1.8*c);else if(e.kind===`cow`||e.kind===`pig`||e.kind===`sheep`||e.kind===`chicken`||e.kind===`farmer`||e.kind===`civilian`){if(a<220&&(e.flee=1.6),e.flee>0){e.flee-=c;let t=a||1,r=e.kind===`chicken`?95:e.kind===`cow`?55:80,o=n/t*r,s=i/t*r;e.vx+=(o-e.vx)*(1-Math.exp(-7*c)),e.vy+=(s-e.vy)*(1-Math.exp(-7*c))}else e.wanderT-=c,e.wanderT<=0&&(e.wanderT=1.2+Math.random()*2.4,e.wanderA=Math.random()*Math.PI*2),e.vx+=(Math.cos(e.wanderA)*22-e.vx)*(1-Math.exp(-4*c)),e.vy+=(Math.sin(e.wanderA)*22-e.vy)*(1-Math.exp(-4*c))}!Hl(e)&&e.kind!==`prop`&&Kl(e,c)}Zl(r);for(let e of r.lasers){if(e.dead)continue;let n=e.x,i=e.y;if(e.x+=e.vx*c,e.y+=e.vy*c,e.wanderT-=c,e.wanderT<=0||e.x<0||e.y<0||e.x>4896||e.y>3600){e.dead=!0;continue}for(let a of r.actors)if(!(a.dead||!a.destructible)&&Ql(n,i,e.x,e.y,a.x,a.y,a.r+12)){e.dead=!0,a.hp-=22*(l.laserMult||1)*(1+(l.weaponTier??0)*.28),a.flash=.08,Jl(a,e.vx*.08,e.vy*.08),t.hit(),tu(r,e.x,e.y,6,`#9dffc4`,90),a.hp<=0&&iu(r,a,`blast`);break}}for(let e of r.bullets){if(e.dead)continue;let t=e.x,n=e.y;if(e.x+=e.vx*c,e.y+=e.vy*c,e.wanderT-=c,e.wanderT<=0){e.dead=!0;continue}if(Ql(t,n,e.x,e.y,u.x,u.y,u.r+8)){if(e.dead=!0,(l.cloakT??0)>0){tu(r,e.x,e.y,5,`#c9a0ff`,70);continue}let t=Math.hypot(e.vx,e.vy)||1;u.knockX=(u.knockX??0)+e.vx/t*220,u.knockY=(u.knockY??0)+e.vy/t*220,_u(r,e.dmg??1)}}r.lasers=r.lasers.filter(e=>!e.dead),r.bullets=r.bullets.filter(e=>!e.dead),r.actors=r.actors.filter(e=>!e.dead||e.kind===`rubble`);for(let e of r.particles)e.alive&&(e.life-=c,e.x+=e.vx*c,e.y+=e.vy*c,e.vy+=e.gravity*c,e.life<=0&&(e.alive=!1));for(let e of r.popups)e.life-=c,e.y-=28*c;r.popups=r.popups.filter(e=>e.life>0);for(let e of r.shouts){e.life-=c;let t=r.actors.find(t=>t.id===e.id);t&&!t.dead?(e.x=t.x,e.y=t.y-36-t.lift*40):e.y-=18*c}r.shouts=r.shouts.filter(e=>e.life>0);for(let e of r.explosions)e.t+=c;r.explosions=r.explosions.filter(e=>e.t<.45);let D=u.x+u.vx*.18,O=u.y+u.vy*.18;l.camX+=(D-l.camX)*(1-Math.exp(-7*c)),l.camY+=(O-l.camY)*(1-Math.exp(-7*c))}function xu(e,t,n,r,i,a){let o=Cu(e);return{x:(t-e.state.camX)*a+r/2+o.x,y:(n-e.state.camY)*a+i/2+o.y}}function Su(e,t,n,r,i,a){let o=Cu(e);return{x:(t-r/2-o.x)/a+e.state.camX,y:(n-i/2-o.y)/a+e.state.camY}}function Cu(e){let t=e.state.shake*e.state.shake;return t<=0?{x:0,y:0}:{x:(Math.random()*2-1)*t*14,y:(Math.random()*2-1)*t*14}}function wu(e){if(!e)return null;let t=new Ht(e);return t.colorSpace=tt,t.minFilter=D,t.magFilter=D,t.generateMipmaps=!1,t.needsUpdate=!0,t}function Tu(e){return new Z(parseInt(e.replace(`#`,``),16))}function Eu(e){let t=new Cl({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`,stencil:!1,preserveDrawingBuffer:!0});t.setClearColor(1185807,1),t.outputColorSpace=tt,t.toneMapping=0,t.autoClear=!0;let n=new jn;n.fog=new An(659478,55e-5);let r=new La(-200,200,200,-200,.1,1600);r.up.set(0,0,-1),r.position.set(0,520,0),r.lookAt(0,0,0),n.add(new Sa(7177896,1840656,.85)),n.add(new Ba(2371648,.35));let i=new za(9085128,.35);i.position.set(-200,400,-120),n.add(i);let s=new Ia(12120272,3.4,420,1.6);s.position.set(0,70,0),n.add(s);let c=new Ia(7330714,1.4,180,2);n.add(c);let l=[];for(let e=0;e<3;e++){let e=new Ia(16751178,0,280,2);n.add(e),l.push(e)}let u=new pi(new qi(o+400,a+400),new ti({color:1713176}));u.rotation.x=-Math.PI/2,u.position.set(o/2,-1,a/2),n.add(u);let d=new Sn;n.add(d);let f=[],p=null,m=new qi(72.4,72.4);m.rotateX(-Math.PI/2);function h(e){for(let e of f)d.remove(e),e.geometry.dispose(),e.material.dispose();f.length=0;let t=[0,0,0,0];for(let n=0;n<e.terrain.length;n++)t[e.terrain[n]??0]++;let n=new xn;for(let r=0;r<4;r++){let i=y.tile[r],a=new ti({map:wu(i),color:16777215}),o=new Ti(m,a,t[r]||1);o.frustumCulled=!1;let s=0;for(let t=0;t<50;t++)for(let i=0;i<68;i++)(e.terrain[t*68+i]??0)===r&&(n.position.set(i*72+36,0,t*72+36),n.updateMatrix(),o.setMatrixAt(s++,n.matrix));o.instanceMatrix.needsUpdate=!0,d.add(o),f.push(o)}p=e.terrain}let g=new Map;function _(e){let t=g.get(e);return t||(t=wu(e.startsWith(`saucer`)?y.saucer[Number(e.slice(-1))-1]:e.startsWith(`explode`)?y.explode[Number(e.slice(-1))-1]:e.startsWith(`laser`)?y.laser[Number(e.slice(-1))-1]:y.sprite[e])??new Ht,g.set(e,t),t)}let v=new Map,b=new Map;function x(e,t=!1){let n=e+(t?`:add`:``),r=b.get(n);return r||(r=new jr({map:_(e),transparent:!0,depthWrite:!1,color:16777215,blending:t?2:1}),b.set(n,r),r)}function S(e,t,r=!1){let i=v.get(e);return i?i.material.map!==x(t,r).map&&(i.material=x(t,r)):(i=new Gr(x(t,r)),i.center.set(.5,.45),n.add(i),v.set(e,i)),i.visible=!0,i}let C=new Float32Array(1200),w=new Float32Array(1200),T=new Float32Array(400),E=new Tr;E.setAttribute(`position`,new ur(C,3)),E.setAttribute(`color`,new ur(w,3)),E.setAttribute(`size`,new ur(T,1));let D=new Pi({size:5,vertexColors:!0,transparent:!0,depthWrite:!1,blending:2,sizeAttenuation:!0}),O=new zi(E,D);O.frustumCulled=!1,n.add(O);let k=new Ki(78,32);k.rotateX(-Math.PI/2);let A=new ti({color:8257474,transparent:!0,opacity:.22,blending:2,depthWrite:!1}),j=new pi(k,A);j.visible=!1,n.add(j);let ee=new Ji(62,70,40);ee.rotateX(-Math.PI/2);let te=new pi(ee,new ti({color:11993056,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:2}));n.add(te);let M=null,ne=()=>!1;function N(){M?.dispose();let i=new Ml(t);i.addPass(new Nl(n,r));let a=new Fl(new K(e.width,e.height),.42,.7,.82);i.addPass(a),i.addPass(new Ll),M=i}let P=new Set,re=()=>{let n=Math.min(e.clientWidth<500?1.35:1.75,window.devicePixelRatio||1),r=Math.max(1,e.clientWidth),i=Math.max(1,e.clientHeight);t.setPixelRatio(n),t.setSize(r,i,!1),M?.setSize(r,i),ne()&&!M&&N(),ne()||(M=null)};re();let ie=new Z;return{resize:re,render(i,a){p!==i.terrain&&h(i);let o=e.clientWidth,u=e.clientHeight,d=o>u?u/380:o/400;i.state.camZoom=d;let f=u/d,m=o/d;r.left=-m/2,r.right=m/2,r.top=f/2,r.bottom=-f/2,r.updateProjectionMatrix();let g=Cu(i),_=i.state.camX+g.x/d,y=i.state.camY+g.y/d;r.position.set(_,520,y),r.lookAt(_,0,y);let b=i.saucer;s.position.set(b.x,78,b.y),s.intensity=i.beamOn?5.2:3.1,c.position.set(b.x,40,b.y),c.intensity=i.beamOn?2.4:1.1;let x=.55+Math.sin(a*.014)*.12;j.visible=i.beamOn,te.visible=i.beamOn,i.beamOn&&(j.position.set(b.x,1.4,b.y+8),j.scale.setScalar(.92+x*.18),A.opacity=.16+x*.14,te.position.set(b.x,1.8,b.y+8),te.material.opacity=.22+x*.2);for(let e=0;e<l.length;e++){let t=i.explosions[e],n=l[e];if(!t){n.intensity=0;continue}n.position.set(t.x,36,t.y),n.intensity=(1-t.t/.45)*8}P.clear();let D=Math.sin(a*.006)*4,O=Math.floor(a/140)%4,k=S(-1,Rl(i.state.craftId,i.saucer.sprite,O));k.position.set(b.x,18+D,b.y),k.scale.set(b.w,b.h,1),k.material.rotation=i.state.craftId===`disc`?0:-b.facing;let ee=(i.state.cloakT??0)>0;k.material.opacity=ee?.28+x*.22:b.flash>0&&Math.floor(a/70)%2==0?.5:1,s.color.setHex(ee?13213951:12120272),c.color.setHex(ee?10121440:7330714),k.renderOrder=b.y+400,P.add(-1);let N=_-m/2-120,re=_+m/2+120,ae=y-f/2-120,F=y+f/2+120;for(let e of i.actors){if(e.dead&&e.kind!==`rubble`||e.x<N||e.x>re||e.y<ae||e.y>F)continue;let t=e.kind===`rubble`?e.sprite:e.propKey?e.propKey:e.sprite,n=S(e.id,t),r=e.lift>0?Math.min(36,e.lift*48):0,i=e.kind===`loot`?6+Math.sin(a*.008+e.id)*5:e.abductable?Math.sin(a*.004+e.id)*1.2:0;n.position.set(e.x,8+r+i,e.y);let o=e.kind===`loot`?1+Math.sin(a*.01)*.12:1;n.scale.set(e.w*o,e.h*o,1),n.material.rotation=e.kind===`jeep`||e.kind===`tank`||e.kind===`heli`||e.kind===`plane`||e.kind===`rival`||e.spin?-e.facing:0,n.material.opacity=e.kind===`rubble`?.9:e.flash>0?.75:1,n.material.color.setHex((e.flash,16777215)),n.renderOrder=e.y,P.add(e.id)}let oe=0;for(let e of i.lasers){let t=S(e.id,`laser-${oe++%4+1}`,!0);t.position.set(e.x,14,e.y),t.scale.set(34,16,1),t.material.rotation=-e.facing,t.renderOrder=e.y+200,P.add(e.id)}for(let e of i.bullets){let t=S(e.id,`laser-1`,!0);t.position.set(e.x,12,e.y),t.scale.set(10,10,1),t.material.color.setHex(16738880),t.renderOrder=e.y+180,P.add(e.id)}for(let e of i.explosions){let t=Math.min(3,Math.floor(e.t/.45*4)),n=S(9e5+(e.x|0)+(e.y|0),`explode-${t+1}`,!0),r=90*e.scale*(.85+e.t);n.position.set(e.x,20,e.y),n.scale.set(r,r,1),n.material.opacity=1-e.t*.45,n.renderOrder=e.y+300,P.add(9e5+(e.x|0)+(e.y|0))}for(let[e,t]of v)P.has(e)||(t.visible=!1);let I=0;for(let e of i.particles){if(!e.alive||I>=400)continue;let t=I*3;C[t]=e.x,C[t+1]=10+e.size,C[t+2]=e.y,ie.copy(Tu(e.color));let n=Math.max(0,e.life/e.max);w[t]=ie.r*n,w[t+1]=ie.g*n,w[t+2]=ie.b*n,T[I]=e.size*2.2,I++}for(let e=I;e<400;e++)C[e*3+1]=-40,T[e]=0;E.getAttribute(`position`).needsUpdate=!0,E.getAttribute(`color`).needsUpdate=!0,E.getAttribute(`size`).needsUpdate=!0,E.setDrawRange(0,I),M&&ne()?M.render():t.render(n,r)},dispose(){M?.dispose(),t.dispose(),m.dispose(),k.dispose(),ee.dispose(),E.dispose(),D.dispose();for(let e of f)e.material.dispose();for(let e of b.values())e.dispose();for(let e of g.values())e.dispose()}}}var Du=1/60;function Ou(e,r,i){let s=0,l=performance.now(),u=0,d=0,p=!0,m=r.state.phase,h=Eu(e),g=()=>{h.resize()};g();let _=new ResizeObserver(g);_.observe(e),window.addEventListener(`orientationchange`,g),window.visualViewport?.addEventListener(`resize`,g),window.__controlsTest={getYaw:()=>r.qaYaw,getSpeed:()=>Math.hypot(r.saucer.vx,r.saucer.vy),getX:()=>r.saucer.x,getY:()=>r.saucer.y,setKeys:e=>i.setKeys(e),setSteer:e=>i.setSteer(e),restart:()=>{i.reset(),yu(r,`retry`),l=performance.now(),u=0,v()},getMove:()=>({x:i.actions.moveX,y:i.actions.moveY}),smashNearestSpecial:()=>vu(r),getLoot:()=>r.actors.filter(e=>e.kind===`loot`&&!e.dead).length,getTier:()=>r.state.weaponTier,getCloak:()=>r.state.cloakT,getLevel:()=>r.state.level,endSector:()=>{r.state.timeLeft=.05}};let v=()=>{let t=r.state,i=r.state.camZoom||1,s=[{x:r.saucer.x/o,y:r.saucer.y/a,t:`you`}];for(let e of r.actors)e.dead||(e.kind===`special`?s.push({x:e.x/o,y:e.y/a,t:e.loot===`cloak`?`cloak`:`gun`}):e.kind===`loot`?s.push({x:e.x/o,y:e.y/a,t:`loot`}):e.kind===`rival`?s.push({x:e.x/o,y:e.y/a,t:`jeep`}):(e.kind===`jeep`||e.kind===`tank`||e.kind===`heli`||e.kind===`plane`)&&s.push({x:e.x/o,y:e.y/a,t:e.kind}));let l=n();c({phase:t.phase,score:t.score,combo:t.combo,heat:t.heat,timeLeft:t.timeLeft,hp:t.hp,maxHp:t.maxHp,abducted:t.stats.abducted,destroyed:t.stats.destroyed,best:Math.max(f(),t.score),stats:t.stats,reason:t.reason,alert:t.alert,...t.phase===`playing`?{craftId:t.craftId||`disc`}:{},shouts:(r.shouts??[]).map(t=>{let n=xu(r,t.x,t.y,e.clientWidth,e.clientHeight,i);return{...t,x:n.x,y:n.y}}),weaponTier:t.weaponTier??0,cloakT:t.cloakT??0,level:t.level||l.level,salvage:l.salvage,shield:t.shield??0,shieldMax:t.shieldMax??0,marks:s})},y=n=>{if(!p)return;let a=(n-l)/1e3;if(l=n,a>.1&&(a=.1),i.update(),i.hasMouseAim&&!i.sticks.some(e=>e.kind===`aim`)){let t=r.state.camZoom||1,n=Su(r,i.mouseX,i.mouseY,e.clientWidth,e.clientHeight,t),a=n.x-r.saucer.x,o=n.y-r.saucer.y,s=Math.hypot(a,o);s>8&&(i.actions.aimX=a/s,i.actions.aimY=o/s)}for(r.state.phase===`playing`&&i.justPause?(r.state.phase=`paused`,t.stopBeam(),v()):r.state.phase===`paused`&&i.justPause&&(r.state.phase=`playing`,v()),u+=a;u>=Du;)r.state.phase===`playing`&&(r.state.hitstop>0?r.state.hitstop-=Du:bu(r,i.actions,Du)),u-=Du;m===`playing`&&r.state.phase!==`playing`&&r.state.phase!==`paused`&&i.reset(),m=r.state.phase,h.render(r,n),d+=a,d>.08&&(d=0,v()),s=requestAnimationFrame(y)};return s=requestAnimationFrame(y),v(),{world:r,destroy(){p=!1,cancelAnimationFrame(s),_.disconnect(),window.removeEventListener(`orientationchange`,g),window.visualViewport?.removeEventListener(`resize`,g),t.stopBeam(),h.dispose(),delete window.__controlsTest},start(e=`start`){i.reset(),t.unlock(),yu(r,e),l=performance.now(),u=0,v()},pause(){r.state.phase===`playing`&&(r.state.phase=`paused`),v()},resume(){r.state.phase===`paused`&&(r.state.phase=`playing`),v()}}}export{Ou as runGame};