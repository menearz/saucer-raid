...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wo(e,t,n){let r=new Float32Array(lo),i=new q(0,1,0);return new Ki({name:`SphericalGaussianBlur`,defines:{n:lo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function To(){return new Ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(){return new Ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Do(),fragmentShader:`
	...
	`}var Oo=class extends Pt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};wl.BlurDirectionX=new K(1,0),wl.BlurDirectionY=new K(0,1);var Tl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},El=class extends ml{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ui.clone(Tl.uniforms),this.material=new qi({name:Tl.name,uniforms:this.uniforms,vertexShader:Tl.vertexShader,fragmentShader:Tl.fragmentShader}),this._fsQuad=new _l(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Dl=96,Ol={saucer:14,cow:5,pig:3.4,sheep:2.8,chicken:.9,farmer:2.4,civilian:2.2,tractor:9,pickup:7,sedan:5.5,jeep:8,barn:0,farmhouse:0,townhouse:0,shop:0,silo:0,prop:0,rubble:2.2,laser:.2,bullet:.15};function kl(e){if(e.invMass!=null)return e.invMass;let t=e.mass??Ol[e.kind]??2;return t>0?1/t:0}function Al(e){return kl(e)===0}function jl(e,t){return e+512<<16|t+512&65535}function Ml(e,t){let n=jl(Math.floor(t.x/Dl),Math.floor(t.y/Dl)),r=e.get(n);r||(r=[],e.set(n,r)),r.push(t)}function Nl(e,t,n,r,i){i.length=0;let a=Math.floor((t+r)/Dl),o=Math.floor((t-r)/Dl),s=Math.floor((n+r)/Dl),c=Math.floor((n-r)/Dl);for(let t=c;t<=s;t++)for(let n=o;n<=a;n++){let r=e.get(jl(n,t));if(r)for(let e of r)i.push(e)}return i}function Pl(t,n){let r=t.drag??(t.kind===`rubble`?2.4:1.6),i=Math.exp(-r*n);t.vx*=i,t.vy*=i,t.x+=t.vx*n,t.y+=t.vy*n,t.spin&&(t.facing+=t.spin*n),t.x<36?(t.x=36,t.vx=Math.abs(t.vx)*(t.restitution??.2)):t.x>4860&&(t.x=a-36,t.vx=-Math.abs(t.vx)*(t.restitution??.2)),t.y<36?(t.y=36,t.vy=Math.abs(t.vy)*(t.restitution??.2)):t.y>3564&&(t.y=e-36,t.vy=-Math.abs(t.vy)*(t.restitution??.2))}function Fl(e,t){let n=kl(e),r=kl(t);if(n===0&&r===0)return;let i=t.x-e.x,a=t.y-e.y,o=e.r+t.r,s=i*i+a*a;if(s>o*o||s<1e-8)return;let c=Math.sqrt(s),l=i/c,u=a/c,d=o-c,f=n+r;e.x-=l*d*(n/f),e.y-=u*d*(n/f),t.x+=l*d*(r/f),t.y+=u*d*(r/f);let p=t.vx-e.vx,m=t.vy-e.vy,h=p*l+m*u;if(h>0)return;let g=-(1+Math.min(e.restitution??.15,t.restitution??.15))*h/f;e.vx-=g*l*n,e.vy-=g*u*n,t.vx+=g*l*r,t.vy+=g*u*r}function Il(e,t,n){let r=kl(e);r!==0&&(e.vx+=t*r,e.vy+=n*r)}function Ll(e,t,n,r,i){let a=r*r;for(let o of e.actors){if(o.dead&&o.kind!==`rubble`)continue;let e=o.x-t,s=o.y-n,c=e*e+s*s;if(c>a||c<1)continue;let l=Math.sqrt(c),u=1-l/r;Il(o,e/l*i*u,s/l*i*u),o.spin=(o.spin??0)+(Math.random()-.5)*8*u,o.flee=Math.max(o.flee,1.1)}let o=e.saucer,s=o.x-t,c=o.y-n,l=s*s+c*c;if(l<a&&l>1){let e=Math.sqrt(l),t=1-e/r;o.knockX=(o.knockX??0)+s/e*90*t,o.knockY=(o.knockY??0)+c/e*90*t}}function Rl(e,t,n,r){let i=(t-e.x)*22-e.vx*6,a=(n-16-e.y)*22-e.vy*6;Il(e,i*r*18,a*r*18),e.lift+=r}function zl(e){let t=new Map;for(let n of e.actors)n.dead&&n.kind!==`rubble`||Ml(t,n);let n=[];for(let r of e.actors)if(!(r.dead&&r.kind!==`rubble`)&&!Al(r)){Nl(t,r.x,r.y,r.r+48,n);for(let e of n)e.id<=r.id||e.dead&&e.kind!==`rubble`||!r.solid&&!e.solid&&r.kind!==`rubble`&&e.kind!==`rubble`&&(!r.abductable||!e.abductable)||Fl(r,e)}}function Bl(e,t,n,r,i,a,o){let s=n-e,c=r-t,l=e-i,u=t-a,d=s*s+c*c,f=2*(l*s+u*c),p=l*l+u*u-o*o;if(d<1e-8)return p<=0;let m=f*f-4*d*p;if(m<0)return!1;m=Math.sqrt(m);let h=(-f-m)/(2*d),g=(-f+m)/(2*d);return h>=0&&h<=1||g>=0&&g<=1||h<0&&g>1}function Vl(e,t,n){return Math.max(t,Math.min(n,e))}function Hl(e,t,n,r,i,a,o,s,c=0){let l=e.particles.find(e=>!e.alive);l&&(l.alive=!0,l.x=t,l.y=n,l.vx=r,l.vy=i,l.life=a,l.max=a,l.size=o,l.color=s,l.gravity=c)}function Ul(e,t,n,r,i,a=180){for(let o=0;o<r;o++){let r=Math.random()*Math.PI*2,o=a*(.35+Math.random());Hl(e,t,n,Math.cos(r)*o,Math.sin(r)*o,.35+Math.random()*.45,2+Math.random()*4,i,40)}}function Wl(e,t,n,r){e.popups.push({x:t,y:n,text:r,life:.9,max:.9})}function Gl(e,t,n,r){let i=e.state;i.comboTimer>0?i.combo+=1:i.combo=1,i.comboTimer=2.3,i.stats.maxCombo=Math.max(i.stats.maxCombo,i.combo);let a=Math.min(6,1+Math.floor((i.combo-1)/2)),o=t*a;i.score+=o,Wl(e,n,r-20,a>1?`+${o}  ×${a}`:`+${o}`)}function Kl(e,t,n){if(!t.dead){if(t.dead=!0,n===`abduct`)ql(e,t),r.abduct(),Ul(e,t.x,t.y,14,`#7dffb2`,140),Ul(e,t.x,t.y,8,`#e8ffe8`,80);else if(Jl(e,t),r.explode(),e.explosions.push({x:t.x,y:t.y,t:0,scale:t.r>40?1.6:1}),Ul(e,t.x,t.y,22,`#ffb060`,260),Ul(e,t.x,t.y,10,`#3a2a22`,120),Ll(e,t.x,t.y,t.r>40?240:150,t.r>40?980:520),e.state.shake=Math.min(1,e.state.shake+(t.r>40?.55:.32)),e.state.hitstop=t.r>40?.05:.03,t.destructible&&t.kind!==`prop`){let n=t.r>40?5:3;for(let r=0;r<n;r++){let i=Math.PI*2*r/n+Math.random()*.4,a=80+Math.random()*160;e.actors.push({...t,id:t.id+9e4+r,kind:`rubble`,sprite:`rubble-${1+(t.id+r)%4}`,hp:1,dead:!1,destructible:!1,abductable:!1,solid:!1,w:t.w*(.28+Math.random()*.25),h:t.h*(.22+Math.random()*.2),r:t.r*.28,x:t.x+Math.cos(i)*10,y:t.y+Math.sin(i)*10,vx:Math.cos(i)*a,vy:Math.sin(i)*a,spin:(Math.random()-.5)*10,mass:1.6,invMass:1/1.6,restitution:.25,drag:2.2})}}e.state.heat=Vl(e.state.heat+t.heat,0,100)}}function ql(e,t){let n=e.state.stats;n.abducted+=1,(t.kind===`cow`||t.kind===`pig`||t.kind===`sheep`||t.kind===`chicken`)&&(n.cows+=1),(t.kind===`farmer`||t.kind===`civilian`)&&(n.people+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`)&&(n.vehicles+=1),Gl(e,t.score,t.x,t.y)}function Jl(e,t){let n=e.state.stats;n.destroyed+=1,(t.kind===`barn`||t.kind===`farmhouse`||t.kind===`townhouse`||t.kind===`shop`||t.kind===`silo`)&&(n.buildings+=1),(t.kind===`tractor`||t.kind===`pickup`||t.kind===`sedan`||t.kind===`jeep`)&&(n.vehicles+=1),Gl(e,Math.round(t.score*.85),t.x,t.y)}function Yl(e,t){let n=null,r=320;for(let i of e.actors){if(i.dead||!i.destructible&&!i.abductable||i.kind===`rubble`)continue;let e=Math.hypot(i.x-t.x,i.y-t.y);e<r&&(r=e,n=i)}return n}function Xl(e,t,n){let i=Math.hypot(t,n)||1;t/=i,n/=i;let a=e.saucer;e.lasers.push({id:8e4+e.lasers.length,kind:`laser`,x:a.x+t*36,y:a.y+n*36,vx:t*680,vy:n*680,r:8,w:22,h:10,hp:1,maxHp:1,facing:Math.atan2(n,t),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`laser`,flash:0,dead:!1,flee:0,wanderT:.7,wanderA:0,fireCd:0,z:a.y}),r.laser(),e.state.shake=Math.min(1,e.state.shake+.08)}function Zl(t){let n=Math.floor(Math.random()*4),r=80,i=80;n===0?(r=Math.random()*a,i=60):n===1?(r=a-60,i=Math.random()*e):n===2?(r=Math.random()*a,i=e-60):(r=60,i=Math.random()*e),t.actors.push({id:7e4+Math.floor(Math.random()*9999),kind:`jeep`,x:r,y:i,vx:0,vy:0,r:26,w:64,h:40,hp:70,maxHp:70,facing:0,lift:0,abductTime:1.2,abductable:!0,destructible:!0,solid:!1,score:480,heat:3,sprite:`jeep`,flash:0,dead:!1,flee:0,wanderT:0,wanderA:0,fireCd:.6,z:i})}function Ql(e,t=1){e.saucer.flash>0||(e.state.hp=Math.max(0,e.state.hp-t),e.saucer.hp=e.state.hp,e.saucer.flash=.7,e.state.shake=Math.min(1,e.state.shake+.7),r.hurt(),e.state.hp<=0&&(e.state.phase=`over`,e.state.reason=`destroyed`,o(e.state.score),r.explode(),l.gameOver()))}function $l(e){let t=c();Object.assign(e,t),e.state.phase=`playing`,e.state.timeLeft=100,r.ui()}function eu(t,i,s){let c=t.state;if(c.phase!==`playing`)return;if(t.time+=s,c.timeLeft-=s,c.timeLeft<=0){c.timeLeft=0,c.phase=`over`,c.reason=`time`,o(c.score),l.gameOver();return}c.comboTimer=Math.max(0,c.comboTimer-s),c.comboTimer===0&&(c.combo=0),c.heat=Math.max(0,c.heat-1.6*s),c.shake=Math.max(0,c.shake-s*1.8),t.saucer.flash>0&&(t.saucer.flash-=s);let u=t.saucer,d=i.moveX,f=i.moveY,p=330*(i.beam?.72:1),m=d*p,h=f*p;if(u.vx+=(m-u.vx)*(1-Math.exp(-10*s)),u.vy+=(h-u.vy)*(1-Math.exp(-10*s)),u.knockX=(u.knockX??0)*Math.exp(-7*s),u.knockY=(u.knockY??0)*Math.exp(-7*s),u.x=Vl(u.x+(u.vx+(u.knockX??0))*s,48,a-48),u.y=Vl(u.y+(u.vy+(u.knockY??0))*s,48,e-48),d||f){let e=Math.atan2(f,d)-u.facing;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;u.facing+=e*(1-Math.exp(-8*s))}d<-.2&&(t.qaYaw+=2.4*s),d>.2&&(t.qaYaw-=2.4*s);let g=i.aimX,_=i.aimY;if(Math.hypot(g,_)<.15){let e=Yl(t,u);e&&i.fire?(g=e.x-u.x,_=e.y-u.y):Math.hypot(u.vx,u.vy)>20?(g=u.vx,_=u.vy):(g=t.aimX,_=t.aimY)}let v=Math.hypot(g,_)||1;t.aimX=g/v,t.aimY=_/v,t.beamOn=i.beam,i.beam?(r.startBeam(),l.beam()):r.stopBeam(),t.fireCd=Math.max(0,t.fireCd-s),i.fire&&t.fireCd<=0&&(Xl(t,t.aimX,t.aimY),t.fireCd=n);let y=t.actors.filter(e=>e.kind===`jeep`&&!e.dead).length,b=c.heat>75?4:c.heat>50?3:c.heat>32?2:0;t.jeepCd-=s,y<b&&t.jeepCd<=0&&(Zl(t),t.jeepCd=3.2);let x=i.beam;for(let e of t.actors){if(e.dead)continue;e.z=e.y,e.flash>0&&(e.flash-=s),e.fireCd=Math.max(0,e.fireCd-s);let n=e.x-u.x,r=e.y-u.y,i=Math.hypot(n,r);if(x&&e.abductable&&i<82+e.r*.4?(Rl(e,u.x,u.y,s),Hl(t,e.x+(Math.random()-.5)*16,e.y+10,(Math.random()-.5)*20,-80-Math.random()*40,.35,3,`#7dffc2`,0),e.lift>=e.abductTime&&Kl(t,e,`abduct`)):e.lift=Math.max(0,e.lift-s*1.6),e.kind===`jeep`){let n=u.x-e.x,r=u.y-e.y,i=Math.hypot(n,r)||1;if(e.vx+=(n/i*145-e.vx)*(1-Math.exp(-6*s)),e.vy+=(r/i*145-e.vy)*(1-Math.exp(-6*s)),e.facing=Math.atan2(e.vy,e.vx),e.fireCd<=0&&i<520){e.fireCd=1.15;let a=n/i,o=r/i;t.bullets.push({id:6e4+t.bullets.length,kind:`bullet`,x:e.x+a*28,y:e.y+o*28,vx:a*280,vy:o*280,r:6,w:10,h:10,hp:1,maxHp:1,facing:Math.atan2(o,a),lift:0,abductTime:0,abductable:!1,destructible:!1,solid:!1,score:0,heat:0,sprite:`bullet`,flash:0,dead:!1,flee:0,wanderT:1.8,wanderA:0,fireCd:0,z:e.y,mass:.15,invMass:1/.15})}}else if(e.kind===`rubble`)e.spin=(e.spin??0)*Math.exp(-1.8*s);else if(e.kind===`cow`||e.kind===`pig`||e.kind===`sheep`||e.kind===`chicken`||e.kind===`farmer`||e.kind===`civilian`){if(i<220&&(e.flee=1.6),e.flee>0){e.flee-=s;let t=i||1,a=e.kind===`chicken`?95:e.kind===`cow`?55:80,o=n/t*a,c=r/t*a;e.vx+=(o-e.vx)*(1-Math.exp(-7*s)),e.vy+=(c-e.vy)*(1-Math.exp(-7*s))}else e.wanderT-=s,e.wanderT<=0&&(e.wanderT=1.2+Math.random()*2.4,e.wanderA=Math.random()*Math.PI*2),e.vx+=(Math.cos(e.wanderA)*22-e.vx)*(1-Math.exp(-4*s)),e.vy+=(Math.sin(e.wanderA)*22-e.vy)*(1-Math.exp(-4*s))}!Al(e)&&e.kind!==`prop`&&Pl(e,s)}zl(t);for(let e of t.lasers){if(e.dead)continue;let n=e.x,i=e.y;if(e.x+=e.vx*s,e.y+=e.vy*s,e.wanderT-=s,e.wanderT<=0||e.x<0||e.y<0||e.x>4896||e.y>3600){e.dead=!0;continue}for(let a of t.actors)if(!(a.dead||!a.destructible)&&Bl(n,i,e.x,e.y,a.x,a.y,a.r+12)){e.dead=!0,a.hp-=22,a.flash=.08,Il(a,e.vx*.08,e.vy*.08),r.hit(),Ul(t,e.x,e.y,6,`#9dffc4`,90),a.hp<=0&&Kl(t,a,`blast`);break}}for(let e of t.bullets){if(e.dead)continue;let n=e.x,r=e.y;if(e.x+=e.vx*s,e.y+=e.vy*s,e.wanderT-=s,e.wanderT<=0){e.dead=!0;continue}if(Bl(n,r,e.x,e.y,u.x,u.y,u.r+8)){e.dead=!0;let n=Math.hypot(e.vx,e.vy)||1;u.knockX=(u.knockX??0)+e.vx/n*220,u.knockY=(u.knockY??0)+e.vy/n*220,Ql(t,1)}}t.lasers=t.lasers.filter(e=>!e.dead),t.bullets=t.bullets.filter(e=>!e.dead),t.actors=t.actors.filter(e=>!e.dead||e.kind===`rubble`);for(let e of t.particles)e.alive&&(e.life-=s,e.x+=e.vx*s,e.y+=e.vy*s,e.vy+=e.gravity*s,e.life<=0&&(e.alive=!1));for(let e of t.popups)e.life-=s,e.y-=28*s;t.popups=t.popups.filter(e=>e.life>0);for(let e of t.explosions)e.t+=s;t.explosions=t.explosions.filter(e=>e.t<.45);let S=u.x+u.vx*.18,C=u.y+u.vy*.18;c.camX+=(S-c.camX)*(1-Math.exp(-7*s)),c.camY+=(C-c.camY)*(1-Math.exp(-7*s))}function tu(e,t,n,r,i,a){let o=nu(e);return{x:(t-r/2-o.x)/a+e.state.camX,y:(n-i/2-o.y)/a+e.state.camY}}function nu(e){let t=e.state.shake*e.state.shake;return t<=0?{x:0,y:0}:{x:(Math.random()*2-1)*t*14,y:(Math.random()*2-1)*t*14}}function ru(e){if(!e)return null;let t=new jt(e);return t.colorSpace=Ge,t.minFilter=g,t.magFilter=g,t.generateMipmaps=!1,t.needsUpdate=!0,t}function iu(e){return new Z(parseInt(e.replace(`#`,``),16))}function au(n){let r=new fl({canvas:n,antialias:!1,alpha:!1,powerPreference:`high-performance`,stencil:!1,preserveDrawingBuffer:!0});r.setClearColor(1185807,1),r.outputColorSpace=Ge,r.toneMapping=0,r.autoClear=!0;let i=new bn;i.fog=new yn(659478,55e-5);let o=new Ea(-200,200,200,-200,.1,1600);o.up.set(0,0,-1),o.position.set(0,520,0),o.lookAt(0,0,0),i.add(new da(7177896,1840656,.85)),i.add(new ka(2371648,.35));let s=new Oa(9085128,.35);s.position.set(-200,400,-120),i.add(s);let c=new Ta(12120272,3.4,420,1.6);c.position.set(0,70,0),i.add(c);let l=new Ta(7330714,1.4,180,2);i.add(l);let u=[];for(let e=0;e<3;e++){let e=new Ta(16751178,0,280,2);i.add(e),u.push(e)}let d=new ni(new Ii(a+400,e+400),new Wr({color:1713176}));d.rotation.x=-Math.PI/2,d.position.set(a/2,-1,e/2),i.add(d);let f=new dn;i.add(f);let p=[],m=null,h=new Ii(72.4,72.4);h.rotateX(-Math.PI/2);function g(e){for(let e of p)f.remove(e),e.geometry.dispose(),e.material.dispose();p.length=0;let n=[0,0,0,0];for(let t=0;t<e.terrain.length;t++)n[e.terrain[t]??0]++;let r=new un;for(let i=0;i<4;i++){let a=t.tile[i],o=new Wr({map:ru(a),color:16777215}),s=new mi(h,o,n[i]||1);s.frustumCulled=!1;let c=0;for(let t=0;t<50;t++)for(let n=0;n<68;n++)(e.terrain[t*68+n]??0)===i&&(r.position.set(n*72+36,0,t*72+36),r.updateMatrix(),s.setMatrixAt(c++,r.matrix));s.instanceMatrix.needsUpdate=!0,f.add(s),p.push(s)}m=e.terrain}let _=new Map;function v(e){let n=_.get(e);return n||(n=ru(e.startsWith(`saucer`)?t.saucer[Number(e.slice(-1))-1]:e.startsWith(`explode`)?t.explode[Number(e.slice(-1))-1]:e.startsWith(`laser`)?t.laser[Number(e.slice(-1))-1]:t.sprite[e])??new jt,_.set(e,n),n)}let y=new Map,b=new Map;function x(e,t=!1){let n=e+(t?`:add`:``),r=b.get(n);return r||(r=new br({map:v(e),transparent:!0,depthWrite:!1,color:16777215,blending:t?2:1}),b.set(n,r),r)}function S(e,t,n=!1){let r=y.get(e);return r?r.material.map!==x(t,n).map&&(r.material=x(t,n)):(r=new Pr(x(t,n)),r.center.set(.5,.45),i.add(r),y.set(e,r)),r.visible=!0,r}let C=new Float32Array(1200),w=new Float32Array(1200),T=new Float32Array(400),E=new mr;E.setAttribute(`position`,new $n(C,3)),E.setAttribute(`color`,new $n(w,3)),E.setAttribute(`size`,new $n(T,1));let D=new Ci({size:5,vertexColors:!0,transparent:!0,depthWrite:!1,blending:2,sizeAttenuation:!0}),O=new Oi(E,D);O.frustumCulled=!1,i.add(O);let ee=new Fi(78,32);ee.rotateX(-Math.PI/2);let k=new Wr({color:8257474,transparent:!0,opacity:.22,blending:2,depthWrite:!1}),A=new ni(ee,k);A.visible=!1,i.add(A);let j=new Li(62,70,40);j.rotateX(-Math.PI/2);let M=new ni(j,new Wr({color:11993056,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:2}));i.add(M);let N=null,P=()=>!1;function te(){N?.dispose();let e=new xl(r);e.addPass(new Sl(i,o));let t=new wl(new K(n.width,n.height),.42,.7,.82);e.addPass(t),e.addPass(new El),N=e}let ne=new Set,re=()=>{let e=Math.min(n.clientWidth<500?1.35:1.75,window.devicePixelRatio||1),t=Math.max(1,n.clientWidth),i=Math.max(1,n.clientHeight);r.setPixelRatio(e),r.setSize(t,i,!1),N?.setSize(t,i),P()&&!N&&te(),P()||(N=null)};re();let ie=new Z;return{resize:re,render(e,t){m!==e.terrain&&g(e);let a=n.clientWidth,s=n.clientHeight,d=a>s?s/380:a/400;e.state.camZoom=d;let f=s/d,p=a/d;o.left=-p/2,o.right=p/2,o.top=f/2,o.bottom=-f/2,o.updateProjectionMatrix();let h=nu(e),_=e.state.camX+h.x/d,v=e.state.camY+h.y/d;o.position.set(_,520,v),o.lookAt(_,0,v);let b=e.saucer;c.position.set(b.x,78,b.y),c.intensity=e.beamOn?5.2:3.1,l.position.set(b.x,40,b.y),l.intensity=e.beamOn?2.4:1.1;let x=.55+Math.sin(t*.014)*.12;A.visible=e.beamOn,M.visible=e.beamOn,e.beamOn&&(A.position.set(b.x,1.4,b.y+8),A.scale.setScalar(.92+x*.18),k.opacity=.16+x*.14,M.position.set(b.x,1.8,b.y+8),M.material.opacity=.22+x*.2);for(let t=0;t<u.length;t++){let n=e.explosions[t],r=u[t];if(!n){r.intensity=0;continue}r.position.set(n.x,36,n.y),r.intensity=(1-n.t/.45)*8}ne.clear();let D=Math.sin(t*.006)*4,O=S(-1,`saucer-${Math.floor(t/140)%4+1}`);O.position.set(b.x,18+D,b.y),O.scale.set(92,92,1),O.material.opacity=b.flash>0&&Math.floor(t/70)%2==0?.5:1,O.renderOrder=b.y+400,ne.add(-1);let ee=_-p/2-120,j=_+p/2+120,te=v-f/2-120,re=v+f/2+120;for(let n of e.actors){if(n.dead&&n.kind!==`rubble`||n.x<ee||n.x>j||n.y<te||n.y>re)continue;let e=n.kind===`rubble`?n.sprite:n.propKey?n.propKey:n.sprite,r=S(n.id,e),i=n.lift>0?Math.min(36,n.lift*48):0,a=n.abductable?Math.sin(t*.004+n.id)*1.2:0;r.position.set(n.x,8+i+a,n.y),r.scale.set(n.w,n.h,1),r.material.rotation=n.kind===`jeep`||n.spin?-n.facing:0,r.material.opacity=n.kind===`rubble`?.9:n.flash>0?.75:1,r.material.color.setHex((n.flash,16777215)),r.renderOrder=n.y,ne.add(n.id)}let ae=0;for(let t of e.lasers){let e=S(t.id,`laser-${ae++%4+1}`,!0);e.position.set(t.x,14,t.y),e.scale.set(34,16,1),e.material.rotation=-t.facing,e.renderOrder=t.y+200,ne.add(t.id)}for(let t of e.bullets){let e=S(t.id,`laser-1`,!0);e.position.set(t.x,12,t.y),e.scale.set(10,10,1),e.material.color.setHex(16738880),e.renderOrder=t.y+180,ne.add(t.id)}for(let t of e.explosions){let e=Math.min(3,Math.floor(t.t/.45*4)),n=S(9e5+(t.x|0)+(t.y|0),`explode-${e+1}`,!0),r=90*t.scale*(.85+t.t);n.position.set(t.x,20,t.y),n.scale.set(r,r,1),n.material.opacity=1-t.t*.45,n.renderOrder=t.y+300,ne.add(9e5+(t.x|0)+(t.y|0))}for(let[e,t]of y)ne.has(e)||(t.visible=!1);let oe=0;for(let t of e.particles){if(!t.alive||oe>=400)continue;let e=oe*3;C[e]=t.x,C[e+1]=10+t.size,C[e+2]=t.y,ie.copy(iu(t.color));let n=Math.max(0,t.life/t.max);w[e]=ie.r*n,w[e+1]=ie.g*n,w[e+2]=ie.b*n,T[oe]=t.size*2.2,oe++}for(let e=oe;e<400;e++)C[e*3+1]=-40,T[e]=0;E.getAttribute(`position`).needsUpdate=!0,E.getAttribute(`color`).needsUpdate=!0,E.getAttribute(`size`).needsUpdate=!0,E.setDrawRange(0,oe),N&&P()?N.render():r.render(i,o)},dispose(){N?.dispose(),r.dispose(),h.dispose(),ee.dispose(),j.dispose(),E.dispose(),D.dispose();for(let e of p)e.material.dispose();for(let e of b.values())e.dispose();for(let e of _.values())e.dispose()}}}var ou=1/60;function su(e,t,n){let a=0,o=performance.now(),c=0,l=0,u=!0,d=au(e),f=()=>{d.resize()};f();let p=new ResizeObserver(f);p.observe(e),window.addEventListener(`orientationchange`,f),window.visualViewport?.addEventListener(`resize`,f),window.__controlsTest={getYaw:()=>t.qaYaw,getSpeed:()=>Math.hypot(t.saucer.vx,t.saucer.vy),getX:()=>t.saucer.x,getY:()=>t.saucer.y,setKeys:e=>n.setKeys(e),setSteer:e=>n.setSteer(e)};let m=()=>{let e=t.state;s({phase:e.phase,score:e.score,combo:e.combo,heat:e.heat,timeLeft:e.timeLeft,hp:e.hp,maxHp:e.maxHp,abducted:e.stats.abducted,destroyed:e.stats.destroyed,best:Math.max(i(),e.score),stats:e.stats,reason:e.reason})},h=i=>{if(!u)return;let s=(i-o)/1e3;if(o=i,s>.1&&(s=.1),n.update(),n.hasMouseAim&&!n.sticks.some(e=>e.kind===`aim`)){let r=t.state.camZoom||1,i=tu(t,n.mouseX,n.mouseY,e.clientWidth,e.clientHeight,r),a=i.x-t.saucer.x,o=i.y-t.saucer.y,s=Math.hypot(a,o);s>8&&(n.actions.aimX=a/s,n.actions.aimY=o/s)}for(t.state.phase===`playing`&&n.justPause?(t.state.phase=`paused`,r.stopBeam(),m()):t.state.phase===`paused`&&n.justPause&&(t.state.phase=`playing`,m()),c+=s;c>=ou;)t.state.phase===`playing`&&(t.state.hitstop>0?t.state.hitstop-=ou:eu(t,n.actions,ou)),c-=ou;d.render(t,i),l+=s,l>.08&&(l=0,m()),a=requestAnimationFrame(h)};return a=requestAnimationFrame(h),m(),{world:t,destroy(){u=!1,cancelAnimationFrame(a),p.disconnect(),window.removeEventListener(`orientationchange`,f),window.visualViewport?.removeEventListener(`resize`,f),r.stopBeam(),d.dispose(),delete window.__controlsTest},start(){r.unlock(),$l(t),o=performance.now(),c=0,m()},pause(){t.state.phase===`playing`&&(t.state.phase=`paused`),m()},resume(){t.state.phase===`paused`&&(t.state.phase=`playing`),m()}}}export{su as runGame};